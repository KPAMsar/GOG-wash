!(function (t, e) {
    ...
    const l = (t) => {
        ...
        d = (t) => {
            ...
            return n || t ? ((e = e.split(",")[0]), (i = i.split(",")[0]), 1e3 * (Number.parseFloat(e) + Number.parseFloat(i))) : 0;
        },
        n = (t) => {
        ...
        t = (i, n) => {
            var t = () => {
                ...
                if (t) {
                    const e = t.fn[i];
                    (t.fn[i] = n.jQueryInterface), (t.fn[i].Constructor = n), (t.fn[i].noConflict = () => ((t.fn[i] = e), n.jQueryInterface));
                }
            };
    ...
    var y = function (t, e, i) {
        ...
        _ = (t, e) => (v.has(t) && v.get(t).get(e)) || null,
        b = function (t, e) {
            if (v.has(t)) {
                const i = v.get(t);
    ...
    function L(t, e, i) {
        ...
        let s = t.replace(x, "");
        e = k[s];
        return e && (s = e), A.has(s) || (s = t), [n, i, s];
    }
                ...
                v = u
                    ? ((a = t),
                      ...
                      function i(n) {
                          ...
                          for (let e = n["target"]; e && e !== this; e = e.parentNode) for (let t = s.length; t--; ) if (s[t] === e) return (n.delegateTarget = e), i.oneOff && M.off(a, n.type, c), c.apply(e, [n]);
                          return null;
                      })
                    : ((o = t),
                      (r = i),
                      function t(e) {
                          return (e.delegateTarget = o), t.oneOff && M.off(o, e.type, r), r.apply(o, [e]);
                      });
            var o, r, a, l, c;
            (v.delegationSelector = u ? i : null), (v.originalHandler = h), (v.oneOff = s), (v.uidEvent = g), (f[g] = v), t.addEventListener(d, v, u);
        }
    }
    ...
    const M = {
        ...
        off(i, n, t, e) {
            if ("string" == typeof n && i) {
                const [s, o, r] = L(n, t, e),
                    ...
                    l = D(i),
                    c = n.startsWith(".");
                if (void 0 !== o) return l && l[r] ? void j(i, l, r, o, s ? t : null) : void 0;
                c &&
                    Object.keys(l).forEach((t) => {
                        !(function (e, i, n, s) {
                            ...
                            Object.keys(o).forEach((t) => {
                                if (t.includes(s)) {
                                    const s = o[t];
                                    j(e, i, n, s.originalHandler, s.delegationSelector);
                                }
                            });
                        })(i, l, t, n.slice(1));
                    });
                ...
                Object.keys(u).forEach((t) => {
                    ...
                    if (!a || n.includes(e)) {
                        const n = u[t];
                        j(i, l, r, n.originalHandler, n.delegationSelector);
                    }
                });
            }
        },
        trigger(t, e, i) {
            ...
            let a,
                ...
                h = null;
            return (
                o && n && ((a = n.Event(e, i)), n(t).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (u = a.isDefaultPrevented())),
    ...
    class P {
        constructor(t) {
            (t = "string" == typeof t ? document.querySelector(t) : t) && ((this._element = t), y(this._element, this.constructor.DATA_KEY, this));
        }
        dispose() {
            b(this._element, this.constructor.DATA_KEY), (this._element = null);
        }
        static getInstance(t) {
            return _(t, this.DATA_KEY);
        }
        static get VERSION() {
            return "5.0.0-beta3";
        }
    ...
    class I extends P {
        ...
        _removeElement(t) {
            var e;
            t.classList.remove("show"), t.classList.contains("fade") ? ((e = d(t)), M.one(t, "transitionend", () => this._destroyElement(t)), p(t, e)) : this._destroyElement(t);
        }
        _destroyElement(t) {
    ...
    M.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', I.handleDismiss(new I())), t("alert", I);
    class z extends P {
        static get DATA_KEY() {
            return "bs.button";
        }
        ...
        static jQueryInterface(e) {
            return this.each(function () {
                let t = _(this, "bs.button");
                (t = t || new z(this)), "toggle" === e && t[e]();
            });
        }
    }
    function H(t) {
            ...
            getDataAttributes(i) {
                ...
                return (
                    Object.keys(i.dataset)
                        ...
                        .forEach((t) => {
                            let e = t.replace(/^bs/, "");
                            (e = e.charAt(0).toLowerCase() + e.slice(1, e.length)), (n[e] = H(i.dataset[t]));
                        }),
                    n
                );
            },
            getDataAttribute: (t, e) => H(t.getAttribute("data-bs-" + R(e))),
            offset(t) {
    ...
    class Y extends P {
        ...
        pause(t) {
            t || (this._isPaused = !0), q.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (n(this._element), this.cycle(!0)), clearInterval(this._interval), (this._interval = null);
        }
        cycle(t) {
            t || (this._isPaused = !1),
        ...
        to(t) {
            ...
            if (!(t > this._items.length - 1 || t < 0))
                if (this._isSliding) M.one(this._element, "slid.bs.carousel", () => this.to(t));
                else {
        ...
        _getConfig(t) {
            return (t = { ...W, ...t }), i("carousel", t, B), t;
        }
        _handleSwipe() {
            var t = Math.abs(this.touchDeltaX);
            t <= 40 || ((t = t / this.touchDeltaX), (this.touchDeltaX = 0), t && this._slide(0 < t ? X : U));
        }
        _addEventListeners() {
            this._config.keyboard && M.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
                "hover" === this._config.pause && (M.on(this._element, "mouseenter.bs.carousel", (t) => this.pause(t)), M.on(this._element, "mouseleave.bs.carousel", (t) => this.cycle(t))),
        ...
        _addTouchEventListeners() {
            ...
            q.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                    ? (M.on(this._element, "pointerdown.bs.carousel", (t) => e(t)), M.on(this._element, "pointerup.bs.carousel", (t) => n(t)), this._element.classList.add("pointer-event"))
                    : (M.on(this._element, "touchstart.bs.carousel", (t) => e(t)), M.on(this._element, "touchmove.bs.carousel", (t) => i(t)), M.on(this._element, "touchend.bs.carousel", (t) => n(t)));
        }
        _keydown(t) {
            /input|textarea/i.test(t.target.tagName) || ("ArrowLeft" === t.key ? (t.preventDefault(), this._slide(U)) : "ArrowRight" === t.key && (t.preventDefault(), this._slide(X)));
        }
        _getItemIndex(t) {
        ...
        _getItemByOrder(t, e) {
            ...
            if (((n && 0 === s) || (i && s === t)) && !this._config.wrap) return e;
        ...
        _slide(t, e) {
            ...
            if (o && o.classList.contains("active")) this._isSliding = !1;
                ...
                if (((this._isSliding = !0), a && this.pause(), this._setActiveIndicatorElement(o), (this._activeElement = o), this._element.classList.contains("slide"))) {
                    o.classList.add(u), f(o), n.classList.add(c), o.classList.add(c);
                    const t = d(n);
                    M.one(n, "transitionend", () => {
                        o.classList.remove(c, u),
                            ...
                            (this._isSliding = !1),
                            setTimeout(() => {
                                M.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: h, from: s, to: r });
                            }, 0);
                    }),
                        p(n, t);
                } else n.classList.remove("active"), o.classList.add("active"), (this._isSliding = !1), M.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: h, from: s, to: r });
                a && this.cycle();
            }
        }
        _directionToOrder(t) {
            return [X, U].includes(t) ? (g() ? (t === X ? V : F) : t === X ? F : V) : t;
        }
        _orderToDirection(t) {
            return [F, V].includes(t) ? (g() ? (t === F ? U : X) : t === F ? X : U) : t;
        }
        static carouselInterface(t, e) {
            let i = _(t, "bs.carousel"),
                n = { ...W, ...$.getDataAttributes(t) };
            "object" == typeof e && (n = { ...n, ...e });
            var s = "string" == typeof e ? e : n.slide;
            if (((i = i || new Y(t, n)), "number" == typeof e)) i.to(e);
        ...
        static dataApiClickHandler(t) {
            ...
            if (e && e.classList.contains("carousel")) {
                const i = { ...$.getDataAttributes(e), ...$.getDataAttributes(this) },
                    n = this.getAttribute("data-bs-slide-to");
                n && (i.interval = !1), Y.carouselInterface(e, i), n && _(e, "bs.carousel").to(n), t.preventDefault();
            }
        }
    }
    M.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Y.dataApiClickHandler),
        M.on(window, "load.bs.carousel.data-api", () => {
            var i = q.find('[data-bs-ride="carousel"]');
            for (let t = 0, e = i.length; t < e; t++) Y.carouselInterface(i[t], _(i[t], "bs.carousel"));
        }),
        t("carousel", Y);
    const K = { toggle: !0, parent: "" },
    ...
    class Z extends P {
        constructor(t, i) {
            ...
            var n = q.find('[data-bs-toggle="collapse"]');
            for (let t = 0, e = n.length; t < e; t++) {
                const i = n[t],
                    s = r(i),
                    o = q.find(s).filter((t) => t === this._element);
        ...
        show() {
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                ...
                this._parent &&
                    ...
                    0 === t.length && (t = null));
                const s = q.findOne(this._selector);
                if (t) {
                    const o = t.find((t) => s !== t);
                    if (((e = o ? _(o, "bs.collapse") : null), e && e._isTransitioning)) return;
                }
                if (!M.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                    t &&
                        t.forEach((t) => {
                            s !== t && Z.collapseInterface(t, "hide"), e || y(t, "bs.collapse", null);
                        });
                    ...
                    M.one(this._element, "transitionend", () => {
                        this._element.classList.remove("collapsing"), this._element.classList.add("collapse", "show"), (this._element.style[o] = ""), this.setTransitioning(!1), M.trigger(this._element, "shown.bs.collapse");
                    }),
                        p(this._element, n),
        ...
        _getConfig(t) {
            return ((t = { ...K, ...t }).toggle = Boolean(t.toggle)), i("collapse", t, Q), t;
        }
        _getDimension() {
            return this._element.classList.contains("width") ? "width" : "height";
        }
        _getParent() {
            let t = this._config["parent"];
            a(t) ? (void 0 === t.jquery && void 0 === t[0]) || (t = t[0]) : (t = q.findOne(t));
        ...
        static collapseInterface(t, e) {
            let i = _(t, "bs.collapse");
            const n = { ...K, ...$.getDataAttributes(t), ...("object" == typeof e && e ? e : {}) };
    ...
    M.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function (t) {
        ...
        const n = $.getDataAttributes(this),
            e = r(this);
        q.find(e).forEach((t) => {
            const e = _(t, "bs.collapse");
            let i;
            (i = e ? (null === e._parent && "string" == typeof n.parent && ((e._config.parent = n.parent), (e._parent = e._getParent())), "toggle") : n), Z.collapseInterface(t, i);
        });
    }),
        t("collapse", Z);
    var G = "top",
        ...
        et = "left",
        it = [G, J, tt, et],
        nt = it.reduce(function (t, e) {
            return t.concat([e + "-start", e + "-end"]);
        }, []),
        st = [].concat(it, ["auto"]).reduce(function (t, e) {
            return t.concat([e, e + "-start", e + "-end"]);
        }, []),
        ot = ["beforeRead", "read", "afterRead", "beforeMain", "main", "afterMain", "beforeWrite", "write", "afterWrite"];
    function rt(t) {
    ...
    var ht = {
        ...
        effect: function (t) {
            var n = t.state,
                s = { popper: { position: n.options.strategy, left: "0", top: "0", margin: "0" }, arrow: { position: "absolute" }, reference: {} };
            return (
    ...
    function vt(t) {
        return ((lt(t) ? t.ownerDocument : t.document) || window.document).documentElement;
    }
    function yt(t) {
        return "html" === rt(t) ? t : t.assignedSlot || t.parentNode || (ut(t) ? t.host : null) || vt(t);
    }
    function _t(t) {
        return ct(t) && "fixed" !== gt(t).position ? t.offsetParent : null;
    }
    function bt(t) {
        for (var e, i = at(t), n = _t(t); n && ((e = n), 0 <= ["table", "td", "th"].indexOf(rt(e))) && "static" === gt(n).position; ) n = _t(n);
        return (
            ((!n || ("html" !== rt(n) && ("body" !== rt(n) || "static" !== gt(n).position))) &&
                (n ||
                    (function (t) {
                        for (var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox"), i = yt(t); ct(i) && ["html", "body"].indexOf(rt(i)) < 0; ) {
                            var n = gt(i);
                            if (
                                "none" !== n.transform ||
                                "none" !== n.perspective ||
    ...
    var St = {
            ...
            fn: function (t) {
                var e,
                    ...
                    l = dt(n.placement),
                    c = wt(l),
                    u = 0 <= [et, tt].indexOf(l) ? "height" : "width";
                r &&
                    a &&
                    ((e = kt("number" != typeof (i = "function" == typeof (i = o.padding) ? i(Object.assign({}, n.rects, { placement: n.placement })) : i) ? i : At(i, it))),
                    (t = ft(r)),
                    (l = "y" === c ? G : et),
                    (o = "y" === c ? J : tt),
                    (i = n.rects.reference[u] + n.rects.reference[c] - a[c] - n.rects.popper[u]),
                    (a = a[c] - n.rects.reference[c]),
                    (r = (r = bt(r)) ? ("y" === c ? r.clientHeight || 0 : r.clientWidth || 0) : 0),
                    (l = e[l]),
                    (o = r - t[u] - e[o]),
                    (o = Tt(l, (a = r / 2 - t[u] / 2 + (i / 2 - a / 2)), o)),
                    (n.modifiersData[s] = (((s = {})[c] = o), (s.centerOffset = o - a), s)));
            },
            effect: function (t) {
                var e = t.state,
                    t = t.options.element,
                    t = void 0 === t ? "[data-popper-arrow]" : t;
                null != t && ("string" != typeof t || (t = e.elements.popper.querySelector(t))) && mt(e.elements.popper, t) && (e.elements.arrow = t);
            },
    ...
    function Ot(t) {
        var e,
            ...
            u = t.adaptive,
            h = t.roundOffsets,
            d = !0 === h ? ((e = a.x), (i = a.y), (n = window.devicePixelRatio || 1), { x: Et(Et(e * n) / n) || 0, y: Et(Et(i * n) / n) || 0 }) : "function" == typeof h ? h(a) : a,
            p = d.x,
            f = void 0 === p ? 0 : p,
            m = d.y,
            t = void 0 === m ? 0 : m,
        ...
        u &&
            ((d = "clientHeight"),
            (m = "clientWidth"),
            (a = bt(s)) === at(s) && "static" !== gt((a = vt(s))).position && ((d = "scrollHeight"), (m = "scrollWidth")),
            r === G && ((h = J), (t -= a[d] - o.height), (t *= c ? 1 : -1)),
            r === et && ((n = tt), (f -= a[m] - o.width), (f *= c ? 1 : -1)));
        var u = Object.assign({ position: l }, u && Dt);
        return c
            ? Object.assign({}, u, (((c = {})[h] = i ? "0" : ""), (c[n] = e ? "0" : ""), (c.transform = (p.devicePixelRatio || 1) < 2 ? "translate(" + f + "px, " + t + "px)" : "translate3d(" + f + "px, " + t + "px, 0)"), c))
            : Object.assign({}, u, (((u = {})[h] = i ? t + "px" : ""), (u[n] = e ? f + "px" : ""), (u.transform = ""), u));
    }
    var Lt = {
            name: "computeStyles",
            enabled: !0,
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    i = i.roundOffsets,
                    i = void 0 === i || i,
                    t = { placement: dt(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: t };
                null != e.modifiersData.popperOffsets &&
                    (e.styles.popper = Object.assign({}, e.styles.popper, Ot(Object.assign({}, t, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: n, roundOffsets: i })))),
                    null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, Ot(Object.assign({}, t, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: i })))),
        ...
        jt = {
            ...
            effect: function (t) {
                ...
                return (
                    ...
                    o && r.addEventListener("resize", i.update, Nt),
                    function () {
                        s &&
                            a.forEach(function (t) {
                                t.removeEventListener("scroll", i.update, Nt);
                            }),
                            o && r.removeEventListener("resize", i.update, Nt);
                    }
                );
            },
            data: {},
    ...
    function Rt(t) {
        return pt(vt(t)).left + Ht(t).scrollLeft;
    }
    function $t(t) {
        var e = gt(t),
            i = e.overflow,
    ...
    function qt(t, e) {
        void 0 === e && (e = []);
        var i = (function t(e) {
                return 0 <= ["html", "body", "#document"].indexOf(rt(e)) ? e.ownerDocument.body : ct(e) && $t(e) ? e : t(yt(e));
            })(t),
            t = i === (null == (n = t.ownerDocument) ? void 0 : n.body),
            n = at(i),
            i = t ? [n].concat(n.visualViewport || [], $t(i) ? i : []) : i,
            e = e.concat(i);
        return t ? e : e.concat(qt(yt(i)));
    }
    function Wt(t) {
    ...
    function Bt(t, e) {
        return "viewport" === e
            ? Wt(
                  ...
                  (c = r.clientHeight),
                  (r = o = 0),
                  a && ((l = a.width), (c = a.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((o = a.offsetLeft), (r = a.offsetTop))),
                  { width: l, height: c, x: o + Rt(s), y: r })
              )
            : ct(e)
            ? (((n = pt((i = e))).top = n.top + i.clientTop),
            ...
            : Wt(
                  ...
                  (r = vt(s)),
                  (e = Ht(s)),
                  (n = null == (i = s.ownerDocument) ? void 0 : i.body),
                  (t = xt(r.scrollWidth, r.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0)),
                  (i = xt(r.scrollHeight, r.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0)),
                  (s = -e.scrollLeft + Rt(s)),
                  (e = -e.scrollTop),
                  "rtl" === gt(n || r).direction && (s += xt(r.clientWidth, n ? n.clientWidth : 0) - t),
                  { width: t, height: i, x: s, y: e })
              );
        var i, n, s, o, r, a, l, c;
    }
    function Ft(t) {
    ...
    function Ut(t, e) {
        var i,
            ...
            u = o.padding,
            d = void 0 === u ? 0 : u,
            r = kt("number" != typeof d ? d : At(d, it)),
            o = t.elements.reference,
            u = t.rects.popper,
            d = t.elements[l ? ("popper" === e ? "reference" : "popper") : e],
            d =
                ((i = lt(d) ? d : d.contextElement || vt(t.elements.popper)),
                (l = h),
                (d =
                    "clippingParents" === (d = c)
                        ? ((c = qt(yt((h = i)))),
                          lt((n = 0 <= ["absolute", "fixed"].indexOf(gt(h).position) && ct(h) ? bt(h) : h))
                              ? c.filter(function (t) {
                                    return lt(t) && mt(t, n) && "body" !== rt(t);
                                })
                              : [])
                        : [].concat(d)),
                (d = [].concat(d, [l])),
                ...
                ((l = d.reduce(function (t, e) {
                    e = Bt(i, e);
                    return (t.top = xt(e.top, t.top)), (t.right = Ct(e.right, t.right)), (t.bottom = Ct(e.bottom, t.bottom)), (t.left = xt(e.left, t.left)), t;
                }, Bt(i, l))).width = l.right - l.left),
                (l.height = l.bottom - l.top),
                (l.x = l.left),
                (l.y = l.top),
                l),
            l = pt(o),
            o = Vt({ reference: l, element: u, strategy: "absolute", placement: a }),
            o = Wt(Object.assign({}, u, o)),
            l = "popper" === e ? o : l,
            p = { top: d.top - l.top + r.top, bottom: l.bottom - d.bottom + r.bottom, left: d.left - l.left + r.left, right: l.right - d.right + r.right },
        ...
        return (
            "popper" === e &&
                ...
                Object.keys(p).forEach(function (t) {
                    var e = 0 <= [tt, J].indexOf(t) ? 1 : -1,
                        i = 0 <= [G, J].indexOf(t) ? "y" : "x";
                    p[t] += s[i] * e;
                })),
            p
        );
            ...
            if (!h.modifiersData[i]._skip) {
                for (
                    var n = e.mainAxis,
                        ...
                        a = [t].concat(e).reduce(function (t, e) {
                            return t.concat(
                                "auto" === dt(e)
                                    ? ((i = h),
                                      (s = n = void 0 === (n = { placement: e, boundary: p, rootBoundary: f, padding: d, flipVariations: m, allowedAutoPlacements: g }) ? {} : n),
                                      (t = s.placement),
                                      (o = s.boundary),
                                      (r = s.rootBoundary),
                                      (a = s.padding),
                                      (n = s.flipVariations),
                                      (l = void 0 === (s = s.allowedAutoPlacements) ? st : s),
                                      (c = Ft(t)),
                                      (t = c
                                          ? n
                                              ? nt
                                      ...
                                      (u = (n =
                                          ...
                                          return (t[e] = Ut(i, { placement: e, boundary: o, rootBoundary: r, padding: a })[dt(e)]), t;
                                      }, {})),
                    ...
                    var b = a[_],
                        ...
                        C = 0 <= [G, J].indexOf(w),
                        E = C ? "width" : "height",
                        T = Ut(h, { placement: b, boundary: p, rootBoundary: f, altBoundary: r, padding: d }),
                        C = C ? (x ? tt : et) : x ? J : G;
                    l[E] > c[E] && (C = Pt(C));
                    (x = Pt(C)), (E = []);
                    if (
                        (s && E.push(T[w] <= 0),
                        o && E.push(T[C] <= 0, T[x] <= 0),
                        E.every(function (t) {
                            return t;
                        }))
                    ) {
                ...
                h.placement !== y && ((h.modifiersData[i]._skip = !0), (h.placement = y), (h.reset = !0));
            }
        },
    ...
    function Kt(e) {
        return [G, tt, J, et].some(function (t) {
            return 0 <= e[t];
        });
    }
    var Qt = {
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    t = Ut(e, { altBoundary: !0 }),
                    n = Yt(r, n),
                    t = Yt(t, s, o),
                    s = Kt(n),
                    o = Kt(t);
                (e.modifiersData[i] = { referenceClippingOffsets: n, popperEscapeOffsets: t, isReferenceHidden: s, hasPopperEscaped: o }),
                    (e.attributes.popper = Object.assign({}, e.attributes.popper, { "data-popper-reference-hidden": s, "data-popper-escaped": o }));
            },
        },
        Zt = {
            name: "offset",
            ...
            fn: function (t) {
                var r = t.state,
                    ...
                    t = st.reduce(function (t, e) {
                        return (
                            (t[e] =
                                ...
                                (s = a),
                                (o = dt(i)),
                                (e = 0 <= [et, G].indexOf(o) ? -1 : 1),
                                (s = (s = (i = "function" == typeof s ? s(Object.assign({}, n, { placement: i })) : s)[0]) || 0),
                                (i = ((i = i[1]) || 0) * e),
                                0 <= [et, tt].indexOf(o) ? { x: i, y: s } : { x: s, y: i })),
                            t
                        );
                        var i, n, s, o;
                    }, {}),
                    ...
                    n = e.x,
                    e = e.y;
                null != r.modifiersData.popperOffsets && ((r.modifiersData.popperOffsets.x += n), (r.modifiersData.popperOffsets.y += e)), (r.modifiersData[i] = t);
            },
        },
        Gt = {
            name: "popperOffsets",
            ...
            fn: function (t) {
                var e = t.state,
                    t = t.name;
                e.modifiersData[t] = Vt({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
            },
            data: {},
        },
        Jt = {
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    f = i.tetherOffset,
                    m = void 0 === f ? 0 : f,
                    g = Ut(e, { boundary: l, rootBoundary: c, padding: h, altBoundary: u }),
                    v = dt(e.placement),
                    y = Ft(e.placement),
                    _ = !y,
                    b = wt(v),
                    ...
                    C = e.rects.reference,
                    t = e.rects.popper,
                    s = "function" == typeof m ? m(Object.assign({}, e.rects, { placement: e.placement })) : m,
                    r = { x: 0, y: 0 };
                x &&
                    ((o || a) &&
                        ((d = "y" === b ? "height" : "width"),
                        ...
                        (m = "start" === y ? -t[d] : -C[d]),
                        (y = e.elements.arrow),
                        (t = p && y ? ft(y) : { width: 0, height: 0 }),
                        (f = (y = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 })[f]),
                        (c = y[c]),
                        (t = Tt(0, C[d], t[d])),
                        (f = _ ? C[d] / 2 - u - t - f - s : v - t - f - s),
                        (t = _ ? -C[d] / 2 + u + t + c + s : m + t + c + s),
                        (s = (c = e.elements.arrow && bt(e.elements.arrow)) ? ("y" === b ? c.clientTop || 0 : c.clientLeft || 0) : 0),
                        (c = e.modifiersData.offset ? e.modifiersData.offset[e.placement][b] : 0),
                        (s = x[b] + f - c - s),
                        (c = x[b] + t - c),
                        o && ((h = Tt(p ? Ct(l, s) : l, i, p ? xt(h, c) : h)), (x[b] = h), (r[b] = h - i)),
                        a && ((a = (i = x[w]) + g["x" === b ? G : et]), (b = i - g["x" === b ? J : tt]), (b = Tt(p ? Ct(a, s) : a, i, p ? xt(b, c) : b)), (x[w] = b), (r[w] = b - i))),
                    (e.modifiersData[n] = r));
            },
            requiresIfExists: ["offset"],
        };
    ...
    function ie(t) {
        ...
        return function (r, a, e) {
            ...
            var i,
                n,
                l = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, te, f), modifiersData: {}, elements: { reference: r, popper: a }, attributes: {}, styles: {} },
                c = [],
                u = !1,
                h = {
                    state: l,
                    setOptions: function (t) {
                        d(), (l.options = Object.assign({}, f, l.options, t)), (l.scrollParents = { reference: lt(r) ? qt(r) : r.contextElement ? qt(r.contextElement) : [], popper: qt(a) });
                        var e,
                            i,
                            n,
                            s,
                        ...
                        return (
                            ...
                            l.orderedModifiers.forEach(function (t) {
                                var e = t.name,
                                    i = t.options,
                                    t = t.effect;
                                "function" == typeof t && ((i = t({ state: l, name: e, instance: h, options: void 0 === i ? {} : i })), c.push(i || function () {}));
                            }),
                            h.update()
                        );
                    },
                            ...
                            if (ee(e, t)) {
                                (l.rects = {
                                    reference: (function (t, e, i) {
                                        ...
                                        return (
                                            (!o && (o || i)) ||
                                                (("body" === rt(e) && !$t(n)) || (r = (i = e) !== at(i) && ct(i) ? { scrollLeft: i.scrollLeft, scrollTop: i.scrollTop } : Ht(i)),
                                                ct(e) ? (((t = pt(e)).x += e.clientLeft), (t.y += e.clientTop)) : n && (t.x = Rt(n))),
                                            { x: s.left + r.scrollLeft - t.x, y: s.top + r.scrollTop - t.y, width: s.width, height: s.height }
                                        );
                                    })(e, bt(t), "fixed" === l.options.strategy),
                                    popper: ft(t),
                                }),
                                    (l.reset = !1),
                                ...
                                for (var i, n, s, o = 0; o < l.orderedModifiers.length; o++)
                                    !0 !== l.reset
                                        ? ((i = (s = l.orderedModifiers[o]).fn), (n = s.options), (s = s.name), "function" == typeof i && (l = i({ state: l, options: void 0 === n ? {} : n, name: s, instance: h }) || l))
                                        : ((l.reset = !1), (o = -1));
                            }
                        }
                    },
            ...
            return (
                ee(r, a) &&
                    h.setOptions(e).then(function (t) {
    ...
    var ne = ie(),
        se = ie({ defaultModifiers: [jt, Gt, Lt, ht] }),
        oe = ie({ defaultModifiers: [jt, Gt, Lt, ht, Zt, Xt, Jt, St, Qt] }),
        re = Object.freeze({
            __proto__: null,
            popperGenerator: ie,
            detectOverflow: Ut,
    ...
    const ae = new RegExp("ArrowUp|ArrowDown|Escape"),
        ...
        ue = g() ? "bottom-end" : "bottom-start",
        he = g() ? "bottom-start" : "bottom-end",
        de = g() ? "left-start" : "right-start",
        pe = g() ? "right-start" : "left-start",
        fe = { offset: [0, 2], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null },
    ...
    class ge extends P {
        ...
        toggle() {
            var t;
            this._element.disabled || this._element.classList.contains("disabled") || ((t = this._element.classList.contains("show")), ge.clearMenus(), t || this.show());
        }
        show() {
            if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                ...
                if (!M.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    if (this._inNavbar) $.setDataAttribute(this._menu, "popper", "none");
                        ...
                        (this._popper = oe(t, this._menu, i)), n && $.setDataAttribute(this._menu, "popper", "static");
                    }
                    "ontouchstart" in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t) => M.on(t, "mouseover", null, function () {})),
                        this._element.focus(),
        ...
        hide() {
            ...
            this._element.disabled ||
                ...
                M.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
                    (this._popper && this._popper.destroy(), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), $.removeDataAttribute(this._menu, "popper"), M.trigger(this._element, "hidden.bs.dropdown", t)));
        }
        dispose() {
            M.off(this._element, ".bs.dropdown"), (this._menu = null), this._popper && (this._popper.destroy(), (this._popper = null)), super.dispose();
        }
        update() {
        ...
        _getPlacement() {
            ...
            return t.classList.contains("dropup") ? (e ? ce : le) : e ? he : ue;
        }
        _detectNavbar() {
        ...
        static dropdownInterface(t, e) {
            let i = _(t, "bs.dropdown");
            if (((i = i || new ge(t, "object" == typeof e ? e : null)), "string" == typeof e)) {
                if (void 0 === i[e]) throw new TypeError(`No method named "${e}"`);
                i[e]();
            }
        }
        static jQueryInterface(t) {
            return this.each(function () {
                ge.dropdownInterface(this, t);
            });
        }
        static clearMenus(i) {
            if (i) {
                if (2 === i.button || ("keyup" === i.type && "Tab" !== i.key)) return;
                if (/input|select|textarea|form/i.test(i.target.tagName)) return;
            }
            const n = q.find('[data-bs-toggle="dropdown"]');
            for (let t = 0, e = n.length; t < e; t++) {
                const s = _(n[t], "bs.dropdown"),
                    o = { relatedTarget: n[t] };
                if ((i && "click" === i.type && (o.clickEvent = i), s)) {
                    const r = s._menu;
                    if (n[t].classList.contains("show")) {
                        if (i) {
                            if ([s._element].some((t) => i.composedPath().includes(t))) continue;
                            if ("keyup" === i.type && "Tab" === i.key && r.contains(i.target)) continue;
                        }
                        M.trigger(n[t], "hide.bs.dropdown", o).defaultPrevented ||
                            ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t) => M.off(t, "mouseover", null, function () {})),
                            n[t].setAttribute("aria-expanded", "false"),
                            s._popper && s._popper.destroy(),
                            r.classList.remove("show"),
                            n[t].classList.remove("show"),
                            $.removeDataAttribute(r, "popper"),
                            M.trigger(n[t], "hidden.bs.dropdown", o));
                    }
                }
            }
        }
        ...
        static dataApiKeydownHandler(e) {
            if (
                (/input|textarea/i.test(e.target.tagName) ? !("Space" === e.key || ("Escape" !== e.key && (("ArrowDown" !== e.key && "ArrowUp" !== e.key) || e.target.closest(".dropdown-menu")))) : ae.test(e.key)) &&
                (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))
            ) {
                var t = ge.getParentFromElement(this),
                    i = this.classList.contains("show");
                if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : q.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void ge.clearMenus();
                if (i || ("ArrowUp" !== e.key && "ArrowDown" !== e.key))
                    if (i && "Space" !== e.key) {
                        const n = q.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(o);
                        if (n.length) {
                            let t = n.indexOf(e.target);
                            "ArrowUp" === e.key && 0 < t && t--, "ArrowDown" === e.key && t < n.length - 1 && t++, (t = -1 === t ? 0 : t), n[t].focus();
                        }
                    } else ge.clearMenus();
                else (this.matches('[data-bs-toggle="dropdown"]') ? this : q.prev(this, '[data-bs-toggle="dropdown"]')[0]).click();
            }
        }
    }
    M.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', ge.dataApiKeydownHandler),
        M.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", ge.dataApiKeydownHandler),
        M.on(document, "click.bs.dropdown.data-api", ge.clearMenus),
        M.on(document, "keyup.bs.dropdown.data-api", ge.clearMenus),
        M.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', function (t) {
            t.preventDefault(), ge.dropdownInterface(this);
        }),
        t("dropdown", ge);
    const ve = { backdrop: !0, keyboard: !0, focus: !0 },
    ...
    class _e extends P {
        ...
        show(t) {
            ...
            this._isShown ||
                ...
                (e = M.trigger(this._element, "show.bs.modal", { relatedTarget: t })),
                this._isShown ||
                    e.defaultPrevented ||
                    ((this._isShown = !0),
                    ...
                    M.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (t) => this.hide(t)),
        ...
        hide(t) {
            if ((t && t.preventDefault(), this._isShown && !this._isTransitioning && !M.trigger(this._element, "hide.bs.modal").defaultPrevented)) {
                ...
                if (
                    ...
                    M.one(this._element, "transitionend", (t) => this._hideModal(t)), p(this._element, e);
                } else this._hideModal();
            }
        }
        dispose() {
            [window, this._element, this._dialog].forEach((t) => M.off(t, ".bs.modal")),
                super.dispose(),
                M.off(document, "focusin.bs.modal"),
                (this._config = null),
                (this._dialog = null),
        ...
        _showElement(t) {
            ...
            if (e) {
                const t = d(this._dialog);
                M.one(this._dialog, "transitionend", n), p(this._dialog, t);
            } else n();
        }
        _enforceFocus() {
            M.off(document, "focusin.bs.modal"),
        ...
        _hideModal() {
            (this._element.style.display = "none"),
                ...
                (this._isTransitioning = !1),
                this._showBackdrop(() => {
                    document.body.classList.remove("modal-open"), this._resetAdjustments(), this._resetScrollbar(), M.trigger(this._element, "hidden.bs.modal");
                });
        }
        _removeBackdrop() {
        ...
        _showBackdrop(t) {
            ...
            if (this._isShown && this._config.backdrop)
                (this._backdrop = document.createElement("div")),
                    ...
                    e ? ((i = d(this._backdrop)), M.one(this._backdrop, "transitionend", t), p(this._backdrop, i)) : t();
                ...
                if (e) {
                    const t = d(this._backdrop);
                    M.one(this._backdrop, "transitionend", i), p(this._backdrop, t);
                } else i();
            } else t();
        }
        _isAnimated() {
        ...
        _setElementAttributes(t, n, s) {
            q.find(t).forEach((t) => {
                var e, i;
                (t !== document.body && window.innerWidth > t.clientWidth + this._scrollbarWidth) || ((e = t.style[n]), (i = window.getComputedStyle(t)[n]), $.setDataAttribute(t, n, e), (t.style[n] = s(Number.parseFloat(i)) + "px"));
            });
        }
        _resetScrollbar() {
        ...
        _resetElementAttributes(t, i) {
            q.find(t).forEach((t) => {
                var e = $.getDataAttribute(t, i);
                void 0 === e && t === document.body ? (t.style[i] = "") : ($.removeDataAttribute(t, i), (t.style[i] = e));
            });
        }
        _getScrollbarWidth() {
        ...
        static jQueryInterface(i, n) {
            return this.each(function () {
                let t = _(this, "bs.modal");
                var e = { ...ve, ...$.getDataAttributes(this), ...("object" == typeof i && i ? i : {}) };
                if (((t = t || new _e(this, e)), "string" == typeof i)) {
    ...
    const be = () => {
        ...
        we = (t, n, s) => {
            ...
            q.find(t).forEach((t) => {
                var e, i;
                (t !== document.body && window.innerWidth > t.clientWidth + o) || ((e = t.style[n]), (i = window.getComputedStyle(t)[n]), $.setDataAttribute(t, n, e), (t.style[n] = s(Number.parseFloat(i)) + "px"));
            });
        },
        xe = (t, i) => {
            q.find(t).forEach((t) => {
                var e = $.getDataAttribute(t, i);
                void 0 === e && t === document.body ? t.style.removeProperty(i) : ($.removeDataAttribute(t, i), (t.style[i] = e));
            });
        },
        Ce = { backdrop: !0, keyboard: !0, scroll: !1 },
        Ee = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" };
    class Te extends P {
        constructor(t, e) {
        ...
        show(t) {
            ...
            this._isShown ||
                ...
                this._config.scroll ||
                    ((e = be()), (document.body.style.overflow = "hidden"), we(".fixed-top, .fixed-bottom, .is-fixed", "paddingRight", (t) => t + e), we(".sticky-top", "marginRight", (t) => t - e), we("body", "paddingRight", (t) => t + e)),
                ...
                this._element.classList.add("show"),
                setTimeout(() => {
                    this._element.classList.remove("offcanvas-toggling"), M.trigger(this._element, "shown.bs.offcanvas", { relatedTarget: t }), this._enforceFocusOnElement(this._element);
                }, d(this._element)));
        }
        hide() {
            this._isShown &&
                (M.trigger(this._element, "hide.bs.offcanvas").defaultPrevented ||
                    ...
                    setTimeout(() => {
                        this._element.setAttribute("aria-hidden", !0),
                            ...
                            this._config.scroll || ((document.body.style.overflow = "auto"), xe(".fixed-top, .fixed-bottom, .is-fixed", "paddingRight"), xe(".sticky-top", "marginRight"), xe("body", "paddingRight")),
                            M.trigger(this._element, "hidden.bs.offcanvas"),
                            this._element.classList.remove("offcanvas-toggling");
                    }, d(this._element))));
        }
        _getConfig(t) {
            return (t = { ...Ce, ...$.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }), i("offcanvas", t, Ee), t;
        }
        ...
        _addEventListeners() {
            M.on(this._element, "click.dismiss.bs.offcanvas", '[data-bs-dismiss="offcanvas"]', () => this.hide()),
                ...
                M.on(document, "click.bs.offcanvas.data-api", (t) => {
                    var e = q.findOne(r(t.target));
                    this._element.contains(t.target) || e === this._element || this.hide();
                });
        }
        static jQueryInterface(e) {
            return this.each(function () {
                const t = _(this, "bs.offcanvas") || new Te(this, "object" == typeof e ? e : {});
                if ("string" == typeof e) {
    ...
    M.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (t) {
        ...
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            c(this) ||
                ...
                ((t = q.findOne(".offcanvas.show, .offcanvas-toggling")) && t !== e) || (_(e, "bs.offcanvas") || new Te(e)).toggle(this));
    }),
        M.on(window, "load.bs.offcanvas.data-api", () => {
            q.find(".offcanvas.show").forEach((t) => (_(t, "bs.offcanvas") || new Te(t)).show());
        }),
        t("offcanvas", Te);
            ...
            if (o.includes(s)) {
                ...
                a.forEach((t) => {
                    ((t, e) => {
                        ...
                        if (e.includes(i)) return !ke.has(i) || Boolean(Ae.test(t.nodeValue) || Se.test(t.nodeValue));
    ...
    const Oe = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ...
        je = { AUTO: "auto", TOP: "top", RIGHT: g() ? "left" : "right", BOTTOM: "bottom", LEFT: g() ? "right" : "left" },
        Me = {
            animation: !0,
    ...
    class Ie extends P {
        ...
        show() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                if (!e.defaultPrevented && n) {
                    ...
                    var t = "function" == typeof this.config.placement ? this.config.placement.call(this, s, this._element) : this.config.placement,
                        t = this._getAttachment(t);
                    this._addAttachmentClass(t);
                    const r = this._getContainer();
                    y(s, this.constructor.DATA_KEY, this),
                        this._element.ownerDocument.documentElement.contains(this.tip) || (r.appendChild(s), M.trigger(this._element, this.constructor.Event.INSERTED)),
                        this._popper ? this._popper.update() : (this._popper = oe(this._element, s, this._getPopperConfig(t))),
                    ...
                    t = () => {
                        ...
                        (this._hoverState = null), M.trigger(this._element, this.constructor.Event.SHOWN), "out" === t && this._leave(null, this);
                    };
                    if (this.tip.classList.contains("fade")) {
                        const l = d(this.tip);
                        M.one(this.tip, "transitionend", t), p(this.tip, l);
                    } else t();
                }
            }
        }
        hide() {
            if (this._popper) {
                ...
                M.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented ||
                    ...
                    "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t) => M.off(t, "mouseover", h)),
                    (this._activeTrigger.click = !1),
                    (this._activeTrigger.focus = !1),
                    (this._activeTrigger.hover = !1),
                    this.tip.classList.contains("fade") ? ((t = d(e)), M.one(e, "transitionend", i), p(e, t)) : i(),
                    (this._hoverState = ""));
            }
        }
        update() {
        ...
        setElementContent(t, e) {
            if (null !== t)
                return "object" == typeof e && a(e)
                    ...
                    : void (this.config.html ? (this.config.sanitize && (e = De(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
        }
        getTitle() {
        ...
        _initializeOnDelegatedTarget(t, e) {
            ...
            return (e = e || _(t.delegateTarget, i)) || ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), y(t.delegateTarget, i, e)), e;
        }
        _getOffset() {
            const e = this.config["offset"];
            return "string" == typeof e ? e.split(",").map((t) => Number.parseInt(t, 10)) : "function" == typeof e ? (t) => e(t, this._element) : e;
        }
        _getPopperConfig(t) {
            t = {
        ...
        _getContainer() {
            return !1 === this.config.container ? document.body : a(this.config.container) ? this.config.container : q.findOne(this.config.container);
        }
        _getAttachment(t) {
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach((t) => {
                var e;
                "click" === t
                    ? M.on(this._element, this.constructor.Event.CLICK, this.config.selector, (t) => this.toggle(t))
                    : "manual" !== t &&
                      ...
                      M.on(this._element, t, this.config.selector, (t) => this._leave(t)));
            }),
        ...
        _getConfig(t) {
            ...
            return (
                ...
                t.sanitize && (t.template = De(t.template, t.allowList, t.sanitizeFn)),
                t
            );
        }
        _getDelegateConfig() {
        ...
        static jQueryInterface(i) {
            return this.each(function () {
                let t = _(this, "bs.tooltip");
                var e = "object" == typeof i && i;
                if ((t || !/dispose|hide/.test(i)) && ((t = t || new Ie(this, e)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError(`No method named "${i}"`);
                    t[i]();
                }
            });
    ...
    t("tooltip", Ie);
    const ze = new RegExp("(^|\\s)bs-popover\\S+", "g"),
        He = {
            ...Ie.Default,
            placement: "right",
            offset: [0, 8],
        ...
        Re = { ...Ie.DefaultType, content: "(string|element|function)" },
        $e = {
    ...
    class qe extends Ie {
        ...
        static jQueryInterface(i) {
            return this.each(function () {
                let t = _(this, "bs.popover");
                var e = "object" == typeof i ? i : null;
                if ((t || !/dispose|hide/.test(i)) && (t || ((t = new qe(this, e)), y(this, "bs.popover", t)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError(`No method named "${i}"`);
                    t[i]();
                }
            });
    ...
    class Fe extends P {
        ...
        refresh() {
            ...
            (this._offsets = []),
                ...
                q
                    ...
                    .map((t) => {
                        const e = r(t),
                            i = e ? q.findOne(e) : null;
                        if (i) {
                            const t = i.getBoundingClientRect();
                            if (t.width || t.height) return [$[n](i).top + s, e];
                        }
                        return null;
                    })
                    .filter((t) => t)
        ...
        _getConfig(e) {
            if ("string" != typeof (e = { ...We, ...("object" == typeof e && e ? e : {}) }).target && a(e.target)) {
                let t = e.target["id"];
                t || ((t = l("scrollspy")), (e.target.id = t)), (e.target = "#" + t);
            }
            return i("scrollspy", e, Be), e;
        }
        _getScrollTop() {
        ...
        _activate(e) {
            ...
            i.classList.contains("dropdown-item")
                ? (q.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"), i.classList.add("active"))
                ...
                M.trigger(this._scrollElement, "activate.bs.scrollspy", { relatedTarget: e });
        }
        _clear() {
        ...
        static jQueryInterface(e) {
            return this.each(function () {
                let t = _(this, "bs.scrollspy");
                if (((t = t || new Fe(this, "object" == typeof e && e)), "string" == typeof e)) {
    ...
    M.on(window, "load.bs.scrollspy.data-api", () => {
        q.find('[data-bs-spy="scroll"]').forEach((t) => new Fe(t, $.getDataAttributes(t)));
    }),
        t("scrollspy", Fe);
    class Ve extends P {
        static get DATA_KEY() {
        ...
        show() {
            if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active")) || c(this._element))) {
                let t;
                const i = s(this._element),
                    n = this._element.closest(".nav, .list-group");
                if (n) {
                    const i = "UL" === n.nodeName || "OL" === n.nodeName ? ":scope > li > .active" : ".active";
                    (t = q.find(i, n)), (t = t[t.length - 1]);
                }
                var e = t ? M.trigger(t, "hide.bs.tab", { relatedTarget: this._element }) : null;
                M.trigger(this._element, "show.bs.tab", { relatedTarget: t }).defaultPrevented ||
        ...
        _activate(t, e, i) {
            const n = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? q.children(e, ".active") : q.find(":scope > li > .active", e))[0],
                s = i && n && n.classList.contains("fade"),
                o = () => this._transitionComplete(t, n, i);
            if (n && s) {
                const t = d(n);
                n.classList.remove("show"), M.one(n, "transitionend", o), p(n, t);
            } else o();
        }
        _transitionComplete(t, e, i) {
            ...
            t.classList.add("active"),
                ...
                t.parentNode && t.parentNode.classList.contains("dropdown-menu") && (t.closest(".dropdown") && q.find(".dropdown-toggle").forEach((t) => t.classList.add("active")), t.setAttribute("aria-expanded", !0)),
                i && i();
        }
        static jQueryInterface(e) {
            return this.each(function () {
                const t = _(this, "bs.tab") || new Ve(this);
                if ("string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
                    t[e]();
                }
    ...
    M.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', function (t) {
        t.preventDefault(), (_(this, "bs.tab") || new Ve(this)).show();
    }),
        t("tab", Ve);
    ...
    class Ye extends P {
        ...
        show() {
            ...
            M.trigger(this._element, "show.bs.toast").defaultPrevented ||
                ...
                this._config.animation ? ((e = d(this._element)), M.one(this._element, "transitionend", t), p(this._element, e)) : t());
        }
        hide() {
            var t, e;
        ...
        dispose() {
            this._clearTimeout(), this._element.classList.contains("show") && this._element.classList.remove("show"), M.off(this._element, "click.dismiss.bs.toast"), super.dispose(), (this._config = null);
        }
        _getConfig(t) {
            return (t = { ...Xe, ...$.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }), i("toast", t, this.constructor.DefaultType), t;
        }
        _setListeners() {
        ...
        static jQueryInterface(e) {
            return this.each(function () {
                let t = _(this, "bs.toast");
                if (((t = t || new Ye(this, "object" == typeof e && e)), "string" == typeof e)) {
                    if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
                    t[e](this);
                }
            });
    ...
    return t("toast", Ye), { Alert: I, Button: z, Carousel: Y, Collapse: Z, Dropdown: ge, Modal: _e, Offcanvas: Te, Popover: qe, ScrollSpy: Fe, Tab: Ve, Toast: Ye, Tooltip: Ie };
}),
    (function (t, e) {
        "use strict";
        ...
        function b(t, e, i) {
            ...
            if (((o.text = t), e)) for (n in u) (s = e[n] || (e.getAttribute && e.getAttribute(n))) && o.setAttribute(n, s);
                            ...
                            (i = t[e]),
                                "__proto__" !== e &&
                                    ...
                                    (l && i && (E.isPlainObject(i) || (n = Array.isArray(i)))
                                        ? ((s = o[e]), (s = n && !Array.isArray(s) ? [] : n || E.isPlainObject(s) ? s : {}), (n = !1), (o[e] = E.extend(l, s, i)))
                                        : void 0 !== i && (o[e] = i));
                return o;
            }),
            E.extend({
                ...
                isPlainObject: function (t) {
                    return !(!t || "[object Object]" !== o.call(t) || ((t = i(t)) && ("function" != typeof (t = y.call(t, "constructor") && t.constructor) || r.call(t) !== c)));
                },
        ...
        var d = (function (i) {
            ...
            try {
                I.apply((e = z.call(_.childNodes)), _.childNodes), e[_.childNodes.length].nodeType;
            } catch (t) {
                I = {
                    apply: e.length
                        ? function (t, e) {
                ...
                if (!n && (x(e), (e = e || C), E)) {
                    if (11 !== h && (a = it.exec(t)))
                        if ((c = a[1])) {
                            ...
                            } else if (u && (o = u.getElementById(c)) && y(e, o) && o.id === c) return i.push(o), i;
                        } else {
                            if (a[2]) return I.apply(i, e.getElementsByTagName(t)), i;
                            if ((c = a[3]) && p.getElementsByClassName && e.getElementsByClassName) return I.apply(i, e.getElementsByClassName(c)), i;
                        }
                    if (p.qsa && !L[t + " "] && (!v || !v.test(t)) && (1 !== h || "object" !== e.nodeName.toLowerCase())) {
                        if (((c = t), (u = e), 1 === h && (Y.test(t) || X.test(t)))) {
                            for (((u = (nt.test(t) && mt(e.parentNode)) || e) === e && p.scope) || ((r = e.getAttribute("id")) ? (r = r.replace(ot, d)) : e.setAttribute("id", (r = T))), s = (l = f(t)).length; s--; )
                                l[s] = (r ? "#" + r : ":scope") + " " + vt(l[s]);
                            c = l.join(",");
                        }
                        try {
            ...
            (x = at.setDocument = function (t) {
                ...
                return (
                    t != C &&
                        ...
                        (E = !s(C)),
                        _ != C && (e = C.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", n, !1) : e.attachEvent && e.attachEvent("onunload", n)),
                        ...
                        (p.getElementsByClassName = et.test(C.getElementsByClassName)),
                        ...
                        (a = []),
                        (v = []),
                        (p.qsa = et.test(C.querySelectorAll)) &&
                            (ut(function (t) {
                                var e;
                                (r.appendChild(t).innerHTML = "<a id='" + T + "'></a><select id='" + T + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                    ...
                                    t.querySelectorAll("[selected]").length || v.push("\\[" + $ + "*(?:value|" + R + ")"),
                        ...
                        (p.matchesSelector = et.test((u = r.matches || r.webkitMatchesSelector || r.mozMatchesSelector || r.oMatchesSelector || r.msMatchesSelector))) &&
                            ut(function (t) {
                                (p.disconnectedMatch = u.call(t, "*")), u.call(t, "[s!='']:x"), a.push("!=", B);
                            }),
            ...
            (at.matchesSelector = function (t, e) {
                if ((x(t), p.matchesSelector && E && !L[e + " "] && (!a || !a.test(e)) && (!v || !v.test(e))))
                    try {
                        var i = u.call(t, e);
            ...
            (at.attr = function (t, e) {
                ...
                var i = b.attrHandle[e.toLowerCase()],
                    i = i && j.call(b.attrHandle, e.toLowerCase()) ? i(t, e, !E) : void 0;
                        ...
                        return 1 === m && 0 === g
                            ...
                            : function (t, e, i) {
                                  ...
                                  if (u) {
                                      if (v) {
                                          for (; c; ) {
                                              for (r = t; (r = r[c]); ) if (_ ? r.nodeName.toLowerCase() === h : 1 === r.nodeType) return !1;
                                      ...
                                      if (((l = [y ? u.firstChild : u.lastChild]), y && d)) {
                                          for (
                                              p = (a = (n = (s = (o = (r = u)[T] || (r[T] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === k && n[1]) && n[2], r = a && u.childNodes[a];
                                      ...
                                      } else if (!1 === (p = d ? (a = (n = (s = (o = (r = t)[T] || (r[T] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === k && n[1]) : p))
                                          for (
                                              ;
                                              (r = (++a && r && r[c]) || (p = a = 0) || l.pop()) &&
                                              ((_ ? r.nodeName.toLowerCase() !== h : 1 !== r.nodeType) || !++p || (d && ((s = (o = r[T] || (r[T] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] = [k, p]), r !== t));
                        ...
                        return r[T]
                            ...
                            ? ((e = [t, t, "", o]),
                              b.setFilters.hasOwnProperty(t.toLowerCase())
                                  ? ct(function (t, e) {
                                        for (var i, n = r(t, o), s = n.length; s--; ) t[(i = H(t, n[s]))] = !(e[i] = n[s]);
                                    })
                                  : function (t) {
                                        return r(t, 0, e);
                                    })
                ...
                return t.first
                    ...
                    : function (t, e, i) {
                          ...
                          if (i) {
                              ...
                              for (; (t = t[a]); )
                                  if (1 === t.nodeType || u)
                                      if (((n = (s = t[T] || (t[T] = {}))[t.uniqueID] || (s[t.uniqueID] = {})), l && l === t.nodeName.toLowerCase())) t = t[a] || t;
                                      else {
                                          if ((s = n[c]) && s[0] === k && s[1] === h) return (o[2] = s[2]);
                                          if (((n[c] = o)[2] = r(t, e, i))) return !0;
                                      }
                          return !1;
                      };
            }
            ...
            function wt(t) {
                for (
                    var n,
                        ...
                        u = [
                            function (t, e, i) {
                                i = (!o && (i || e !== w)) || ((n = e).nodeType ? l : c)(t, e, i);
                                return (n = null), i;
                            },
                        ];
                    a < s;
                                ...
                                return (
                                    ...
                                    ct(function (t, e, i, n) {
                                        var s,
                                            ...
                                            h = !p || (!t && f) ? u : bt(u, a, p, i, n),
                                            d = m ? (v || (t ? p : c || g) ? [] : e) : h;
                                        if ((m && m(h, d, i, n), g)) for (s = bt(d, l), g(s, [], i, n), o = s.length; o--; ) (r = s[o]) && (d[l[o]] = !(h[l[o]] = r));
                                        if (t) {
                                            if (v || p) {
                                                if (v) {
                                                ...
                                                for (o = d.length; o--; ) (r = d[o]) && -1 < (s = v ? H(t, r) : a[o]) && (t[s] = !(e[s] = r));
                                            }
                                        } else (d = bt(d === e ? d.splice(c, d.length) : d)), v ? v(null, e, d, n) : I.apply(e, d);
                                    })
                                );
                            })(1 < a && _t(u), 1 < a && vt(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(V, "$1"), e, a < i && wt(t.slice(a, i)), i < s && wt((t = t.slice(i))), i < s && vt(t));
                        }
                        u.push(e);
                    }
                return _t(u);
            ...
            return (
                ...
                (f = at.tokenize = function (t, e) {
                    ...
                    for (r = t, a = [], l = b.preFilter; r; ) {
                        ...
                        (i = !1),
                        (n = X.exec(r)) && ((i = n.shift()), s.push({ value: i, type: n[0].replace(V, " ") }), (r = r.slice(i.length))),
                        b.filter))
                            !(n = Z[o].exec(r)) || (l[o] && !(n = l[o](n))) || ((i = n.shift()), s.push({ value: i, type: o, matches: n }), (r = r.slice(i.length)));
                        if (!i) break;
                    }
                ...
                (m = at.compile = function (t, e) {
                    var i,
                        ...
                        r = O[t + " "];
                    if (!r) {
                        for (i = (e = e || f(t)).length; i--; ) ((r = wt(e[i]))[T] ? s : o).push(r);
                        (r = O(
                            t,
                            ((y = 0 < (v = s).length),
                            (_ = 0 < (g = o).length),
                            (n = function (t, e, i, n, s) {
                                ...
                                for (s && (w = e == C || e || s); c !== m && null != (o = p[c]); c++) {
                                    if (_ && o) {
                                        for (r = 0, e || o.ownerDocument == C || (x(o), (i = !E)); (a = g[r++]); )
                                            if (a(o, e || C, i)) {
                                                n.push(o);
                                                break;
                                            }
                                ...
                                if (((l += c), y && c !== l)) {
                                    ...
                                    if (t) {
                                        if (0 < l) for (; c--; ) u[c] || h[c] || (h[c] = M.call(n));
                                        h = bt(h);
                                    }
                                    I.apply(n, h), s && !t && 0 < h.length && 1 < l + v.length && at.uniqueSort(n);
                                }
                                return s && ((k = f), (w = d)), u;
                            }),
                            y ? ct(n) : n)
                ...
                (g = at.select = function (t, e, i, n) {
                    ...
                    if (((i = i || []), 1 === u.length)) {
                        if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (r = o[0]).type && 9 === e.nodeType && E && b.relative[o[1].type]) {
                            if (!(e = (b.find.ID(r.matches[0].replace(st, h), e) || [])[0])) return i;
                            c && (e = e.parentNode), (t = t.slice(o.shift().value.length));
                        }
                        for (s = Z.needsContext.test(t) ? 0 : o.length; s-- && ((r = o[s]), !b.relative[(a = r.type)]); )
                            if ((l = b.find[a]) && (n = l(r.matches[0].replace(st, h), (nt.test(o[0].type) && mt(e.parentNode)) || e))) {
                                if ((o.splice(s, 1), !(t = n.length && vt(o)))) return I.apply(i, n), i;
                                break;
                            }
                    }
                    return (c || m(t, u))(n, e, !E, i, !e || (nt.test(t) && mt(e.parentNode)) || e), i;
                }),
            ...
            E.fn.extend({
                find: function (t) {
                    ...
                    if ("string" != typeof t)
                        return this.pushStack(
                            E(t).filter(function () {
                                for (e = 0; e < n; e++) if (E.contains(s[e], this)) return !0;
                            })
                        );
                ...
                is: function (t) {
                    return !!S(this, "string" == typeof t && T.test(t) ? E(t) : t || [], !1).length;
                },
            });
        var D = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
        (E.fn.init = function (t, e, i) {
            if (!t) return this;
            if (((i = i || O), "string" != typeof t)) return t.nodeType ? ((this[0] = t), (this.length = 1), this) : m(t) ? (void 0 !== i.ready ? i.ready(t) : t(E)) : E.makeArray(t, this);
            if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : D.exec(t)) || (!n[1] && e)) return (!e || e.jquery ? e || i : this.constructor(e)).find(t);
            if (n[1]) {
                if (((e = e instanceof E ? e[0] : e), E.merge(this, E.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : C, !0)), A.test(n[1]) && E.isPlainObject(e))) for (var n in e) m(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this;
            }
            ...
            E.each(
                {
                    ...
                    contents: function (t) {
                        return null != t.contentDocument && i(t.contentDocument) ? t.contentDocument : (k(t, "template") && (t = t.content || t), E.merge([], t.childNodes));
                    },
                },
                function (n, s) {
                    E.fn[n] = function (t, e) {
                        var i = E.map(this, s, t);
                        return (e = "Until" !== n.slice(-5) ? t : e) && "string" == typeof e && (i = E.filter(e, i)), 1 < this.length && (N[n] || E.uniqueSort(i), L.test(n) && i.reverse()), this.pushStack(i);
                    };
                }
            );
        var M = /[^\x20\t\r\n\f]+/g;
        ...
        (E.Callbacks = function (n) {
            ...
            n =
                "string" == typeof n
                    ...
                    : E.extend({}, n);
            function s() {
                for (a = a || n.once, r = o = !0; c.length; u = -1) for (e = c.shift(); ++u < l.length; ) !1 === l[u].apply(e[0], e[1]) && n.stopOnFalse && ((u = l.length), (e = !1));
                            ...
                            l &&
                                ...
                                (function i(t) {
                                    E.each(t, function (t, e) {
                                        m(e) ? (n.unique && h.has(e)) || l.push(e) : e && e.length && "string" !== f(e) && i(e);
                                    });
                                })(arguments),
                                e && !o && s()),
                            this
                    ...
                    remove: function () {
                        return (
                            E.each(arguments, function (t, e) {
                                for (var i; -1 < (i = E.inArray(e, l, i)); ) l.splice(i, 1), i <= u && u--;
                            }),
                            this
                        );
                    },
            ...
            E.extend({
                        ...
                        r = {
                            ...
                            then: function (e, i, n) {
                                        ...
                                        function t() {
                                            ...
                                            if (!(s < l)) {
                                                ...
                                                (e = t && ("object" == typeof t || "function" == typeof t) && t.then),
                                                    m(e)
                                                        ? a
                                                            ? e.call(t, c(l, o, P, a), c(l, o, I, a))
                                                            : (l++, e.call(t, c(l, o, P, a), c(l, o, I, a), c(l, o, P, o.notifyWith)))
                                                        : (r !== P && ((i = void 0), (n = [t])), (a || o.resolveWith)(i, n));
                                            }
                                        }
                                        var i = this,
                                            n = arguments,
                                            e = a
                                                ...
                                                : function () {
                                                      try {
                                                          ...
                                                          E.Deferred.exceptionHook && E.Deferred.exceptionHook(t, e.stackTrace), l <= s + 1 && (r !== I && ((i = void 0), (n = [t])), o.rejectWith(i, n));
                                                      }
                                                  };
                                ...
                                return E.Deferred(function (t) {
                                    o[0][3].add(c(0, t, m(n) ? n : P, t.notifyWith)), o[1][3].add(c(0, t, m(e) ? e : P)), o[2][3].add(c(0, t, m(i) ? i : I));
                                }).promise();
                            },
                            promise: function (t) {
                ...
                when: function (t) {
                    ...
                    var i = arguments.length,
                        ...
                        o = a.call(arguments),
                        r = E.Deferred();
                    if (i <= 1 && (z(t, r.done(e(n)).resolve, r.reject, !i), "pending" === r.state() || m(o[n] && o[n].then))) return r.then();
                    for (; n--; ) z(o[n], e(n), r.reject);
                    return r.promise();
                },
            });
        var H = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
        (E.Deferred.exceptionHook = function (t, e) {
            x.console && x.console.warn && t && H.test(t.name) && x.console.warn("jQuery.Deferred exception: " + t.message, t.stack, e);
        }),
        ...
        var R = E.Deferred();
        function $() {
            C.removeEventListener("DOMContentLoaded", $), x.removeEventListener("load", $), E.ready();
        }
        (E.fn.ready = function (t) {
            ...
            (E.ready.then = R.then),
            "complete" === C.readyState || ("loading" !== C.readyState && !C.documentElement.doScroll) ? x.setTimeout(E.ready) : (C.addEventListener("DOMContentLoaded", $), x.addEventListener("load", $));
        function q(t, e, i, n, s, o, r) {
            var a = 0,
                l = t.length,
                c = null == i;
            if ("object" === f(i)) for (a in ((s = !0), i)) q(t, e, a, i[a], !0, o, r);
            else if (
                void 0 !== n &&
                ((s = !0),
                m(n) || (r = !0),
        ...
        function V(t) {
            return t.replace(W, "ms-").replace(B, F);
        }
        function U(t) {
        ...
        E.extend({
            ...
            E.fn.extend({
                data: function (i, t) {
                        ...
                        return "object" == typeof i
                            ...
                            : q(
                                  ...
                                  function (t) {
                                      var e;
                                      return o && void 0 === t
                                          ? void 0 !== (e = K.get(o, i)) || void 0 !== (e = G(o, i))
                                              ? e
                                              : void 0
                    ...
                    if (this.length && ((s = K.get(o)), 1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                        for (e = r.length; e--; ) r[e] && 0 === (n = r[e].name).indexOf("data-") && ((n = V(n.slice(5))), G(o, n, s[n]));
            ...
            E.extend({
                queue: function (t, e, i) {
                    var n;
                    if (t) return (n = Y.get(t, (e = (e || "fx") + "queue"))), i && (!n || Array.isArray(i) ? (n = Y.access(t, e, E.makeArray(i))) : n.push(i)), n || [];
                },
            ...
            E.fn.extend({
                ...
                promise: function (t, e) {
                    ...
                    var n,
                        ...
                        r = this,
                        a = this.length;
                    for ("string" != typeof t && ((e = t), (t = void 0)), t = t || "fx"; a--; ) (n = Y.get(r[a], t + "queueHooks")) && n.empty && (s++, n.empty.add(i));
        ...
        function ot(t, e) {
            return "none" === (t = e || t).style.display || ("" === t.style.display && nt(t) && "none" === E.css(t, "display"));
        }
        function rt(t, e, i, n) {
            var s,
                o,
            ...
            if (u && u[3] !== c) {
                for (c = c || u[3], u = +(l /= 2) || 1; r--; ) E.style(t, e, u + c), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (r = 0), (u /= o);
                E.style(t, e, (u *= 2) + c), (i = i || []);
            }
                        ...
                        ? ("none" === i && ((l[c] = Y.get(n, "display") || null), l[c] || (n.style.display = "")),
                          "" === n.style.display &&
                              ...
                              (l[c] =
                                  ...
                                  (o = n.ownerDocument),
                                  (r = n.nodeName),
                                  (a = at[r]) || ((s = o.body.appendChild(o.createElement(r))), (a = E.css(s, "display")), s.parentNode.removeChild(s), (at[r] = a = "none" === a ? "block" : a)))))
        ...
        var ct = /^(?:checkbox|radio)$/i,
            ...
            dt = C.createDocumentFragment().appendChild(C.createElement("div"));
        ...
        function ft(t, e) {
            ...
            return void 0 === e || (e && k(t, e)) ? E.merge([t], i) : i;
        }
        function mt(t, e) {
            for (var i = 0, n = t.length; i < n; i++) Y.set(t[i], "globalEval", !e || Y.get(e[i], "globalEval"));
        }
        (pt.tbody = pt.tfoot = pt.colgroup = pt.caption = pt.thead), (pt.th = pt.td), _.option || (pt.optgroup = pt.option = [1, "<select multiple='multiple'>", "</select>"]);
        var gt = /<|&#?\w+;/;
            ...
            for (var o, r, a, l, c, u = e.createDocumentFragment(), h = [], d = 0, p = t.length; d < p; d++)
                if ((o = t[d]) || 0 === o)
                    if ("object" === f(o)) E.merge(h, o.nodeType ? [o] : o);
                        ...
                        for (r = r || u.appendChild(e.createElement("div")), a = (ut.exec(o) || ["", ""])[1].toLowerCase(), a = pt[a] || pt._default, r.innerHTML = a[1] + E.htmlPrefilter(o) + a[2], c = a[0]; c--; ) r = r.lastChild;
                        E.merge(h, r.childNodes), ((r = u.firstChild).textContent = "");
                    } else h.push(e.createTextNode(o));
            for (u.textContent = "", d = 0; (o = h[d++]); )
                if (n && -1 < E.inArray(o, n)) s && s.push(o);
                else if (((l = nt(o)), (r = ft(u.appendChild(o), "script")), l && mt(r), i)) for (c = 0; (o = r[c++]); ) ht.test(o.type || "") && i.push(o);
            return u;
        }
        var yt = /^([^.]*)(?:\.(.+)|)/;
        function _t() {
                  ...
                  E.event.add(t, s, {
                      ...
                      handler: function (t) {
                          ...
                          if (1 & t.isTrigger && this[s]) {
                              ...
                              else if (((n = a.call(arguments)), Y.set(this, s, n), (e = o(this, s)), this[s](), n !== (i = Y.get(this, s)) || e ? Y.set(this, s, !1) : (i = {}), n !== i))
                                  return t.stopImmediatePropagation(), t.preventDefault(), i && i.value;
                          } else n.length && (Y.set(this, s, { value: E.event.trigger(E.extend(n[0], E.Event.prototype), n.slice(1), this) }), t.stopImmediatePropagation());
                      },
                  }))
                : void 0 === Y.get(t, s) && E.event.add(t, s, _t);
        }
        (E.event = {
            global: {},
                    ...
                    for (
                        ...
                        (h = p = (c = yt.exec(t[l]) || [])[1]),
                            ...
                            h &&
                                ...
                                (u = E.event.special[h] || {}),
                                (c = E.extend({ type: h, origType: p, data: n, handler: i, guid: i.guid, selector: s, needsContext: s && E.expr.match.needsContext.test(s), namespace: d.join(".") }, o)),
                                (p = a[h]) || (((p = a[h] = []).delegateCount = 0), (u.setup && !1 !== u.setup.call(e, n, d, r)) || (e.addEventListener && e.addEventListener(h, r))),
            ...
            remove: function (t, e, i, n, s) {
                ...
                if (g && (l = g.events)) {
                    for (c = (e = (e || "").match(M) || [""]).length; c--; )
                        if (((p = m = (a = yt.exec(e[c]) || [])[1]), (f = (a[2] || "").split(".").sort()), p)) {
                            for (h = E.event.special[p] || {}, d = l[(p = (n ? h.delegateType : h.bindType) || p)] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = d.length; o--; )
                                (u = d[o]),
                                    (!s && m !== u.origType) ||
                                        (i && i.guid !== u.guid) ||
                            ...
                            r && !d.length && ((h.teardown && !1 !== h.teardown.call(t, f, g.handle)) || E.removeEvent(t, p, g.handle), delete l[p]);
                        } else for (p in l) E.event.remove(t, p + e[c], i, n, !0);
                    E.isEmptyObject(l) && Y.remove(t, "handle events");
                }
            },
            dispatch: function (t) {
                var e,
                ...
                if (((a.delegateTarget = this), !t.preDispatch || !1 !== t.preDispatch.call(this, a))) {
                    for (o = E.event.handlers.call(this, a, l), e = 0; (n = o[e++]) && !a.isPropagationStopped(); )
                        for (a.currentTarget = n.elem, i = 0; (s = n.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                            (a.rnamespace && !1 !== s.namespace && !a.rnamespace.test(s.namespace)) ||
                                ((a.handleObj = s), (a.data = s.data), void 0 !== (s = ((E.event.special[s.origType] || {}).handle || s.handler).apply(n.elem, r)) && !1 === (a.result = s) && (a.preventDefault(), a.stopPropagation()));
                ...
                if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                    for (; c !== this; c = c.parentNode || this)
                        if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                            for (o = [], r = {}, i = 0; i < l; i++) void 0 === r[(s = (n = e[i]).selector + " ")] && (r[s] = n.needsContext ? -1 < E(s, this).index(c) : E.find(s, this, null, [c]).length), r[s] && o.push(n);
            ...
            special: {
                ...
                click: {
                    ...
                    _default: function (t) {
                        t = t.target;
                        return (ct.test(t.type) && t.click && k(t, "input") && Y.get(t, "click")) || k(t, "a");
                    },
                },
                beforeunload: {
            ...
            E.each({ mouseenter: "mouseover", mouseleave: "mouseout", pointerenter: "pointerover", pointerleave: "pointerout" }, function (t, s) {
                E.event.special[t] = {
                    delegateType: s,
                    bindType: s,
                    handle: function (t) {
        ...
        function Ot(t, e) {
            var i, n, s, o;
            if (1 === e.nodeType) {
                if (Y.hasData(t) && (o = Y.get(t).events)) for (s in (Y.remove(e, "handle events"), o)) for (i = 0, n = o[s].length; i < n; i++) E.event.add(e, s, o[s][i]);
        ...
        function Lt(i, n, s, o) {
            ...
            var t,
                ...
                p = n[0],
                f = m(p);
            if (f || (1 < h && "string" == typeof p && !_.checkClone && Tt.test(p)))
                return i.each(function (t) {
                    var e = i.eq(t);
                    f && (n[0] = p.call(this, t, e.html())), Lt(e, n, s, o);
                });
            if (h && ((e = (t = vt(n, i[0].ownerDocument, !1, i, o)).firstChild), 1 === t.childNodes.length && (t = e), e || o)) {
                for (a = (r = E.map(ft(t, "script"), St)).length; u < h; u++) (l = t), u !== d && ((l = E.clone(l, !0, !0)), a && E.merge(r, ft(l, "script"))), s.call(i[u], l, u);
                if (a)
                    for (c = r[r.length - 1].ownerDocument, E.map(r, Dt), u = 0; u < a; u++)
                        (l = r[u]),
                            ht.test(l.type || "") &&
                                !Y.access(l, "globalEval") &&
                                E.contains(c, l) &&
                                (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && !l.noModule && E._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : b(l.textContent.replace(kt, ""), l, c));
            }
            return i;
        }
        function Nt(t, e, i) {
            for (var n, s = e ? E.filter(e, t) : t, o = 0; null != (n = s[o]); o++) i || 1 !== n.nodeType || E.cleanData(ft(n)), n.parentNode && (i && nt(n) && mt(ft(n, "script")), n.parentNode.removeChild(n));
            return t;
        }
        E.extend({
            ...
            clone: function (t, e, i) {
                var n,
                    ...
                    u = t.cloneNode(!0),
                    h = nt(t);
                if (!(_.noCloneChecked || (1 !== t.nodeType && 11 !== t.nodeType) || E.isXMLDoc(t)))
                    for (r = ft(u), n = 0, s = (o = ft(t)).length; n < s; n++)
                        (a = o[n]), "input" === (c = (l = r[n]).nodeName.toLowerCase()) && ct.test(a.type) ? (l.checked = a.checked) : ("input" !== c && "textarea" !== c) || (l.defaultValue = a.defaultValue);
                if (e)
                    if (i) for (o = o || ft(t), r = r || ft(u), n = 0, s = o.length; n < s; n++) Ot(o[n], r[n]);
                    else Ot(t, u);
                return 0 < (r = ft(u, "script")).length && mt(r, !h && ft(t, "script")), u;
            },
            cleanData: function (t) {
                for (var e, i, n, s = E.event.special, o = 0; void 0 !== (i = t[o]); o++)
                    if (U(i)) {
                        if ((e = i[Y.expando])) {
                            if (e.events) for (n in e.events) s[n] ? E.event.remove(i, n) : E.removeEvent(i, n, e.handle);
                            i[Y.expando] = void 0;
                        }
                ...
                html: function (t) {
                    return q(
                        ...
                        function (t) {
                            ...
                            if ("string" == typeof t && !Et.test(t) && !pt[(ut.exec(t) || ["", ""])[1].toLowerCase()]) {
                                t = E.htmlPrefilter(t);
                                try {
            ...
            E.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function (t, r) {
                E.fn[t] = function (t) {
                    for (var e, i = [], n = E(t), s = n.length - 1, o = 0; o <= s; o++) (e = o === s ? this : this.clone(!0)), E(n[o])[r](e), l.apply(i, e.get());
        ...
        function Vt(t, e, i) {
            ...
            return (
                (i = i || jt(t)) &&
                    ("" !== (s = i.getPropertyValue(e) || i[e]) || nt(t) || (s = E.style(t, e)),
                    !_.pixelBoxStyles() && Bt.test(s) && Ft.test(e) && ((n = o.width), (t = o.minWidth), (e = o.maxWidth), (o.minWidth = o.maxWidth = o.width = s), (s = i.width), (o.width = n), (o.minWidth = t), (o.maxWidth = e))),
                void 0 !== s ? s + "" : s
            );
        }
        function Ut(t, e) {
        ...
        function Xt() {
            ...
            Wt &&
                ...
                it.appendChild(qt).appendChild(Wt),
                (t = x.getComputedStyle(Wt)),
                (Pt = "1%" !== t.top),
                ($t = 12 === Yt(t.marginLeft)),
                (Wt.style.right = "60%"),
                (Ht = 36 === Yt(t.right)),
                (It = 36 === Yt(t.width)),
                (Wt.style.position = "absolute"),
                (zt = 12 === Yt(Wt.offsetWidth / 3)),
                it.removeChild(qt),
                (Wt = null));
        }
        function Yt(t) {
        ...
        (qt = C.createElement("div")),
            (Wt = C.createElement("div")).style &&
                ...
                (_.clearCloneStyle = "content-box" === Wt.style.backgroundClip),
                E.extend(_, {
                    ...
                    reliableTrDimensions: function () {
                        ...
                        return (
                            null == Rt &&
                                ...
                                (Rt = parseInt(i.height, 10) + parseInt(i.borderTopWidth, 10) + parseInt(i.borderBottomWidth, 10) === e.offsetHeight),
                                it.removeChild(t)),
                            Rt
                        );
                    },
        ...
        function Gt(t) {
            return (
                ...
                (t in Qt
                    ...
                    : (Zt[t] =
                          (function (t) {
                              for (var e = t[0].toUpperCase() + t.slice(1), i = Kt.length; i--; ) if ((t = Kt[i] + e) in Qt) return t;
                          })(t) || t))
            );
        }
        ...
        function se(t, e, i, n, s, o) {
            ...
            for (; r < 4; r += 2)
                "margin" === i && (l += E.css(t, i + et[r], !0, s)),
                    n
                        ? ("content" === i && (l -= E.css(t, "padding" + et[r], !0, s)), "margin" !== i && (l -= E.css(t, "border" + et[r] + "Width", !0, s)))
                        : ((l += E.css(t, "padding" + et[r], !0, s)), "padding" !== i ? (l += E.css(t, "border" + et[r] + "Width", !0, s)) : (a += E.css(t, "border" + et[r] + "Width", !0, s)));
            return !n && 0 <= o && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - o - l - a - 0.5)) || 0), l;
        }
        function oe(t, e, i) {
            var n = jt(t),
                s = (!_.boxSizingReliable() || i) && "border-box" === E.css(t, "boxSizing", !1, n),
                o = s,
                r = Vt(t, e, n),
            ...
            return (
                ((!_.boxSizingReliable() && s) || (!_.reliableTrDimensions() && k(t, "tr")) || "auto" === r || (!parseFloat(r) && "inline" === E.css(t, "display", !1, n))) &&
                    t.getClientRects().length &&
                    ((s = "border-box" === E.css(t, "boxSizing", !1, n)), (o = a in t) && (r = t[a])),
        ...
        E.extend({
            ...
            style: function (t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var s,
                        ...
                        l = te.test(e),
                        c = t.style;
                    if ((l || (e = Gt(a)), (r = E.cssHooks[e] || E.cssHooks[a]), void 0 === i)) return r && "get" in r && void 0 !== (s = r.get(t, !1, n)) ? s : c[e];
                    "string" == (o = typeof i) && (s = tt.exec(i)) && s[1] && ((i = rt(t, e, s)), (o = "number")),
                        null != i &&
                            i == i &&
            ...
            css: function (t, e, i, n) {
                ...
                return (
                    te.test(e) || (e = Gt(o)),
                    "normal" === (s = void 0 === (s = (o = E.cssHooks[e] || E.cssHooks[o]) && "get" in o ? o.get(t, !0, i) : s) ? Vt(t, e, n) : s) && e in ie && (s = ie[e]),
                    "" === i || i ? ((e = parseFloat(s)), !0 === i || isFinite(e) ? e || 0 : s) : s
                );
            },
        }),
                ...
                E.cssHooks[a] = {
                    ...
                    set: function (t, e, i) {
                        var n,
                            ...
                            r = (o || i) && "border-box" === E.css(t, "boxSizing", !1, s),
                            i = i ? se(t, a, i, r, s) : 0;
                        return (
                            r && o && (i -= Math.ceil(t["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(s[a]) - se(t, a, "border", !1, s) - 0.5)),
                            i && (n = tt.exec(e)) && "px" !== (n[3] || "px") && ((t.style[a] = e), (e = E.css(t, a))),
                            ne(0, e, i)
                        );
                    },
                };
            }),
            (E.cssHooks.marginLeft = Ut(_.reliableMarginLeft, function (t, e) {
                if (e)
                    return (
            ...
            E.each({ margin: "", padding: "", border: "Width" }, function (s, o) {
                (E.cssHooks[s + o] = {
                    ...
                    "margin" !== s && (E.cssHooks[s + o].set = ne);
            }),
            E.fn.extend({
                css: function (t, e) {
                    return q(
                        ...
                        function (t, e, i) {
                            var n,
                                ...
                                r = 0;
                            if (Array.isArray(e)) {
                                for (n = jt(t), s = e.length; r < s; r++) o[e[r]] = E.css(t, e[r], !1, n);
                                return o;
                            }
            ...
            (((E.Tween = re).prototype = {
                constructor: re,
                init: function (t, e, i, n, s, o) {
                    (this.elem = t), (this.prop = i), (this.easing = s || E.easing._default), (this.options = e), (this.start = this.now = this.cur()), (this.end = n), (this.unit = o || (E.cssNumber[i] ? "" : "px"));
                },
                cur: function () {
        ...
        var ae,
            ...
            ue = /queueHooks$/;
        function he() {
            le && (!1 === C.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(he) : x.setTimeout(he, E.fx.interval), E.fx.tick());
        }
        function de() {
            return (
                x.setTimeout(function () {
        ...
        function fe(t, e, i) {
            for (var n, s = (me.tweeners[e] || []).concat(me.tweeners["*"]), o = 0, r = s.length; o < r; o++) if ((n = s[o].call(i, e, t))) return n;
        }
        function me(s, t, e) {
            var i,
                o,
                ...
                l = function () {
                    if (o) return !1;
                    for (var t = ae || de(), t = Math.max(0, c.startTime + c.duration - t), e = 1 - (t / c.duration || 0), i = 0, n = c.tweens.length; i < n; i++) c.tweens[i].run(e);
                    return a.notifyWith(s, [c, e, t]), e < 1 && n ? t : (n || a.notifyWith(s, [c, 1, 0]), a.resolveWith(s, [c]), !1);
                },
                c = a.promise({
                    elem: s,
                    props: E.extend({}, t),
            ...
            for (
                (function (t, e) {
                    var i, n, s, o, r;
                    for (i in t)
                        if (((s = e[(n = V(i))]), (o = t[i]), Array.isArray(o) && ((s = o[1]), (o = t[i] = o[0])), i !== n && ((t[n] = o), delete t[i]), (r = E.cssHooks[n]) && ("expand" in r)))
                ...
                if ((i = me.prefilters[n].call(c, s, u, c.opts))) return m(i.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
            return (
                E.map(u, fe, c),
        ...
        (E.Animation = E.extend(me, {
            ...
            tweener: function (t, e) {
                for (var i, n = 0, s = (t = m(t) ? ((e = t), ["*"]) : t.match(M)).length; n < s; n++) (i = t[n]), (me.tweeners[i] = me.tweeners[i] || []), me.tweeners[i].unshift(e);
            },
            prefilters: [
                function (t, e, i) {
                    var n,
                    ...
                    if ((l = !E.isEmptyObject(e)) || !E.isEmptyObject(d))
                        for (n in (u &&
                            ...
                            "none" === (u = E.css(t, "display")) && (c ? (u = c) : (lt([t], !0), (c = t.style.display || c), (u = E.css(t, "display")), lt([t]))),
                        ...
                        d))
                            l ||
                                (m ? "hidden" in m && (f = m.hidden) : (m = Y.access(t, "fxshow", { display: c })),
                                o && (m.hidden = !f),
                                f && lt([t], !0),
                                h.done(function () {
                                    for (n in (f || lt([t]), Y.remove(t, "fxshow"), d)) E.style(t, n, d[n]);
                                })),
                                (l = fe(f ? m[n] : 0, n, h)),
            ...
            (E.speed = function (t, e, i) {
                var n = t && "object" == typeof t ? E.extend({}, t) : { complete: i || (!i && e) || (m(t) && t), duration: t, easing: (i && e) || (e && !m(e) && e) };
                return (
                    ...
                    (n.old = n.complete),
                    (n.complete = function () {
                        m(n.old) && n.old.call(this), n.queue && E.dequeue(this, n.queue);
                    }),
                    n
                );
            }),
            ...
            E.each({ slideDown: pe("show"), slideUp: pe("hide"), slideToggle: pe("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, n) {
                ...
                attr: function (t, e, i) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o)
                        return void 0 === t.getAttribute
                            ? E.prop(t, e, i)
                            : ((1 === o && E.isXMLDoc(t)) || (s = E.attrHooks[e.toLowerCase()] || (E.expr.match.bool.test(e) ? ge : void 0)),
                              void 0 !== i
                                  ? null === i
                                  ...
                                  : !(s && "get" in s && null !== (n = s.get(t, e))) && null == (n = E.find.attr(t, e))
                                  ? void 0
                                  : n);
                },
                attrHooks: {
                    type: {
                        set: function (t, e) {
                            if (!_.radioValue && "radio" === e && k(t, "input")) {
                                var i = t.value;
        ...
        E.fn.extend({
            ...
            E.extend({
                prop: function (t, e, i) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o)
                        return (
                            (1 === o && E.isXMLDoc(t)) || ((e = E.propFix[e] || e), (s = E.propHooks[e])),
            ...
            E.fn.extend({
                addClass: function (e) {
                    ...
                    if (m(e))
                        return this.each(function (t) {
                            E(this).addClass(e.call(this, t, we(this)));
                        });
                    if ((t = xe(e)).length)
                        for (; (i = this[a++]); )
                            if (((r = we(i)), (n = 1 === i.nodeType && " " + be(r) + " "))) {
                                for (o = 0; (s = t[o++]); ) n.indexOf(" " + s + " ") < 0 && (n += s + " ");
                                r !== (r = be(n)) && i.setAttribute("class", r);
                            }
                    return this;
                },
                removeClass: function (e) {
                    ...
                    if (m(e))
                        return this.each(function (t) {
                            E(this).removeClass(e.call(this, t, we(this)));
                        });
                ...
                toggleClass: function (s, e) {
                    ...
                    return "boolean" == typeof e && r
                        ...
                        ? this.each(function (t) {
                              E(this).toggleClass(s.call(this, t, we(this), e), e);
                          })
                        : this.each(function () {
                              var t, e, i, n;
                              if (r) for (e = 0, i = E(this), n = xe(s); (t = n[e++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                              else (void 0 !== s && "boolean" != o) || ((t = we(this)) && Y.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", (!t && !1 !== s && Y.get(this, "__className__")) || ""));
                          });
                },
                hasClass: function (t) {
                    for (var e, i = 0, n = " " + t + " "; (e = this[i++]); ) if (1 === e.nodeType && -1 < (" " + be(we(e)) + " ").indexOf(n)) return !0;
                    return !1;
                },
            });
        var Ce = /\r/g;
            ...
            val: function (e) {
                ...
                return arguments.length
                    ? ((n = m(e)),
                      this.each(function (t) {
                          1 === this.nodeType &&
                              (null == (t = n ? e.call(this, t, E(this).val()) : e)
                                  ? (t = "")
                                  : "number" == typeof t
                                  ? (t += "")
                                  : Array.isArray(t) &&
                    ...
                    : s
                    ? (i = E.valHooks[s.type] || E.valHooks[s.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(s, "value"))
                        ? t
            ...
            E.extend({
                valHooks: {
                    ...
                    select: {
                        ...
                        set: function (t, e) {
                            for (var i, n, s = t.options, o = E.makeArray(e), r = s.length; r--; ) ((n = s[r]).selected = -1 < E.inArray(E.valHooks.option.get(n), o)) && (i = !0);
        ...
        E.extend(E.event, {
                ...
                if (
                    ...
                    for (s = 0; (f = h[s++]) && !t.isPropagationStopped(); )
                        (u = f),
                            ...
                            (l = (Y.get(f, "events") || Object.create(null))[t.type] && Y.get(f, "handle")) && l.apply(f, e),
                            (l = a && f[a]) && l.apply && U(f) && ((t.result = l.apply(f, e)), !1 === t.result && t.preventDefault());
                    return (
                        (t.type = d),
                        n ||
                            ...
                            (a &&
                                ...
                                ((o = i[a]) && (i[a] = null),
                                (E.event.triggered = d),
                                t.isPropagationStopped() && u.addEventListener(d, Ee),
                                i[d](),
                                t.isPropagationStopped() && u.removeEventListener(d, Ee),
            ...
            simulate: function (t, e, i) {
                t = E.extend(new E.Event(), i, { type: t, isSimulated: !0 });
                    ...
                    E.event.special[n] = {
                        setup: function () {
                            var t = this.ownerDocument || this.document || this,
                                e = Y.access(t, n);
                            e || t.addEventListener(i, s, !0), Y.access(t, n, (e || 0) + 1);
                        },
                        teardown: function () {
                            var t = this.ownerDocument || this.document || this,
                                e = Y.access(t, n) - 1;
                            e ? Y.access(t, n, e) : (t.removeEventListener(i, s, !0), Y.remove(t, n));
                        },
                    };
                });
        var ke = x.location,
        ...
        (E.param = function (t, e) {
            function i(t, e) {
                (e = m(e) ? e() : e), (s[s.length] = encodeURIComponent(t) + "=" + encodeURIComponent(null == e ? "" : e));
            }
            var n,
                s = [];
            if (null == t) return "";
            if (Array.isArray(t) || (t.jquery && !E.isPlainObject(t)))
                ...
                for (n in t)
                    !(function i(n, t, s, o) {
                        if (Array.isArray(t))
                            E.each(t, function (t, e) {
                                s || De.test(n) ? o(n, e) : i(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, s, o);
                            });
            ...
            E.fn.extend({
                ...
                serializeArray: function () {
                    return this.map(function () {
                        ...
                        .filter(function () {
                            var t = this.type;
                            return this.name && !E(this).is(":disabled") && Ne.test(this.nodeName) && !Le.test(t) && (this.checked || !ct.test(t));
                        })
                        .map(function (t, e) {
                            var i = E(this).val();
                            return null == i
        ...
        function Be(o) {
            return function (t, e) {
                ...
                if (m(e)) for (; (i = s[n++]); ) "+" === i[0] ? ((i = i.slice(1) || "*"), (o[i] = o[i] || []).unshift(e)) : (o[i] = o[i] || []).push(e);
            };
        }
        function Fe(e, n, s, o) {
            var r = {},
        ...
        (We.href = ke.href),
            E.extend({
                ...
                ajax: function (t, e) {
                    ...
                    var l,
                        ...
                        b = {
                            ...
                            getResponseHeader: function (t) {
                                var e;
                                if (d) {
                                    if (!i) for (i = {}; (e = Ie.exec(u)); ) i[e[1].toLowerCase() + " "] = (i[e[1].toLowerCase() + " "] || []).concat(e[2]);
                                    e = i[t.toLowerCase() + " "];
                                }
                    ...
                    if (
                        (v.promise(b),
                        (f.url = ((t || f.url || ke.href) + "").replace(He, ke.protocol + "//")),
                    ...
                    if ((f.data && f.processData && "string" != typeof f.data && (f.data = E.param(f.data, f.traditional)), Fe(Re, f, e, b), d)) return b;
                    ...
                    f.hasContent
                        ...
                        : ((s = f.url.slice(c.length)),
                          ...
                          !1 === f.cache && ((c = c.replace(Pe, "$1")), (s = (Se.test(c) ? "&" : "?") + "_=" + Ae.guid++ + s)),
                          (f.url = c + s)),
                    f.ifModified && (E.lastModified[c] && b.setRequestHeader("If-Modified-Since", E.lastModified[c]), E.etag[c] && b.setRequestHeader("If-None-Match", E.etag[c])),
                    ((f.data && f.hasContent && !1 !== f.contentType) || e.contentType) && b.setRequestHeader("Content-Type", f.contentType),
                    b.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + qe + "; q=0.01" : "") : f.accepts["*"]),
                    f.headers))
                        b.setRequestHeader(n, f.headers[n]);
                    if (f.beforeSend && (!1 === f.beforeSend.call(m, b, f) || d)) return b.abort();
                    if (((a = "abort"), y.add(f.complete), b.done(f.success), b.fail(f.error), (l = Fe($e, f, e, b)))) {
                    ...
                    function w(t, e, i, n) {
                        ...
                        d ||
                            ...
                            n
                                ? (f.ifModified && ((i = b.getResponseHeader("Last-Modified")) && (E.lastModified[c] = i), (i = b.getResponseHeader("etag")) && (E.etag[c] = i)),
                                  204 === t || "HEAD" === f.type ? (a = "nocontent") : 304 === t ? (a = "notmodified") : ((a = r.state), (s = r.data), (n = !(o = r.error))))
                            ...
                            y.fireWith(m, [b, a]),
                            p && (g.trigger("ajaxComplete", [b, f]), --E.active || E.event.trigger("ajaxStop")));
                    }
                    return b;
                },
            ...
            E.each(["get", "post"], function (t, s) {
                E[s] = function (t, e, i, n) {
                    return m(e) && ((n = n || i), (i = e), (e = void 0)), E.ajax(E.extend({ url: t, type: s, dataType: n, data: e, success: i }, E.isPlainObject(t) && t));
                };
            }),
            ...
            E.fn.extend({
                wrapAll: function (t) {
                    return (
                        this[0] &&
                            (m(t) && (t = t.call(this[0])),
                            (t = E(t, this[0].ownerDocument).eq(0).clone(!0)),
        ...
        E.ajaxSetup({
            ...
            jsonpCallback: function () {
                var t = Ye.pop() || E.expando + "_" + Ae.guid++;
                return (this[t] = !0), t;
            },
        }),
            E.ajaxPrefilter("json jsonp", function (t, e, i) {
                ...
                if (r || "jsonp" === t.dataTypes[0])
                    return (
                        (n = t.jsonpCallback = m(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                        r ? (t[r] = t[r].replace(Ke, "$1" + n)) : !1 !== t.jsonp && (t.url += (Se.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
                        ...
                        i.always(function () {
                            void 0 === s ? E(x).removeProp(n) : (x[n] = s), t[n] && ((t.jsonpCallback = e.jsonpCallback), Ye.push(n)), o && m(s) && s(o[0]), (o = s = void 0);
                        }),
                        "script"
                    );
            }),
            (_.createHTMLDocument = (((dt = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === dt.childNodes.length)),
            (E.parseHTML = function (t, e, i) {
                return "string" != typeof t
                    ? []
                    : ("boolean" == typeof e && ((i = e), (e = !1)),
                      e || (_.createHTMLDocument ? (((n = (e = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href), e.head.appendChild(n)) : (e = C)),
                      (n = !i && []),
                      (i = A.exec(t)) ? [e.createElement(i[1])] : ((i = vt([t], e, n)), n && n.length && E(n).remove(), E.merge([], i.childNodes)));
                var n;
            }),
            (E.fn.load = function (t, e, i) {
                var n,
                    ...
                    a = t.indexOf(" ");
                return (
                    -1 < a && ((n = be(t.slice(a))), (t = t.slice(0, a))),
                    m(e) ? ((i = e), (e = void 0)) : e && "object" == typeof e && (s = "POST"),
                    0 < r.length &&
                        E.ajax({ url: t, type: s || "GET", dataType: "html", data: e })
                            .done(function (t) {
                                (o = arguments), r.html(n ? E("<div>").append(E.parseHTML(t)).find(n) : t);
                            })
                            .always(
                                i &&
                                    function (t, e) {
            ...
            (E.offset = {
                setOffset: function (t, e, i) {
                    ...
                    "static" === a && (t.style.position = "relative"),
                        ...
                        (n = E.css(t, "top")),
                        (r = E.css(t, "left")),
                        (r = ("absolute" === a || "fixed" === a) && -1 < (n + r).indexOf("auto") ? ((s = (a = l.position()).top), a.left) : ((s = parseFloat(n) || 0), parseFloat(r) || 0)),
                        null != (e = m(e) ? e.call(t, i, E.extend({}, o)) : e).top && (c.top = e.top - o.top + s),
            ...
            E.fn.extend({
                ...
                position: function () {
                    if (this[0]) {
                        ...
                        return { top: e.top - s.top - E.css(n, "marginTop", !0), left: e.left - s.left - E.css(n, "marginLeft", !0) };
                    }
                },
            ...
            E.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (e, s) {
                var o = "pageYOffset" === s;
                E.fn[e] = function (t) {
                    return q(
                        this,
            ...
            E.each(["top", "left"], function (t, i) {
                E.cssHooks[i] = Ut(_.pixelPosition, function (t, e) {
                    if (e) return (e = Vt(t, i)), Bt.test(e) ? E(t).position()[i] + "px" : e;
                });
            }),
        ...
        return (
            (E.noConflict = function (t) {
                return x.$ === E && (x.$ = Ge), t && x.jQuery === E && (x.jQuery = Ze), E;
            }),
            void 0 === t && (x.jQuery = x.$ = E),
            E
        );
    }),
    (function (t) {
        ...
        (u.cleanData =
            ...
            (u.widget = function (t, i, e) {
                ...
                return (
                    ...
                    (u[a] = u[a] || {}),
                    (n = u[a][t]),
                    (s = u[a][t] = function (t, e) {
                        return this._createWidget ? void (arguments.length && this._createWidget(t, e)) : new s(t, e);
                    }),
                    u.extend(s, n, { version: e.version, _proto: u.extend({}, e), _childConstructors: [] }),
                    ...
                    (s.prototype = u.widget.extend(o, { widgetEventPrefix: (n && o.widgetEventPrefix) || t }, r, { constructor: s, namespace: a, widgetName: t, widgetFullName: l })),
                    n
            ...
            (u.widget.extend = function (t) {
                for (var e, i, n = a.call(arguments, 1), s = 0, o = n.length; s < o; s++)
                    for (e in n[s]) (i = n[s][e]), n[s].hasOwnProperty(e) && void 0 !== i && (t[e] = u.isPlainObject(i) ? (u.isPlainObject(t[e]) ? u.widget.extend({}, t[e], i) : u.widget.extend({}, i)) : i);
                return t;
            }),
                    ...
                    return (
                        t
                            ...
                            : (n.length && (i = u.widget.extend.apply(null, [i].concat(n))),
                              this.each(function () {
                                  var t = u.data(this, r);
                                  t ? (t.option(i || {}), t._init && t._init()) : u.data(this, r, new e(i, this));
                              })),
                        s
                    );
                };
            ...
            (u.Widget.prototype = {
                ...
                _setOptionClasses: function (t) {
                    var e, i, n;
                    for (e in t) (n = this.classesElementLookup[e]), t[e] !== this.options.classes[e] && n && n.length && ((i = u(n.get())), this._removeClass(n, e), i.addClass(this._classes({ element: i, keys: e, classes: t, add: !0 })));
                },
                ...
                _classes: function (s) {
                    function t(t, e) {
                        for (var i, n = 0; t.length > n; n++)
                            (i = r.classesElementLookup[t[n]] || u()),
                    ...
                    var o = [],
                        r = this;
                    return (
                        (s = u.extend({ element: this.element, classes: this.options.classes || {} }, s)),
                ...
                _toggleClass: function (t, e, i, n) {
                    var s = "string" == typeof t || null === t,
                        i = { extra: s ? e : i, keys: s ? t : e, element: s ? this.element : t, add: (n = "boolean" == typeof n ? n : i) };
                ...
                _on: function (s, o, t) {
                    ...
                    "boolean" != typeof s && ((t = o), (o = s), (s = !1)),
                        t ? ((o = r = u(o)), (this.bindings = this.bindings.add(o))) : ((t = o), (o = this.element), (r = this.widget())),
                        u.each(t, function (t, e) {
                            function i() {
                                return s || (!0 !== a.options.disabled && !u(this).hasClass("ui-state-disabled")) ? ("string" == typeof e ? a[e] : e).apply(a, arguments) : void 0;
                            }
            ...
            u.each({ show: "fadeIn", hide: "fadeOut" }, function (o, r) {
                u.Widget.prototype["_" + o] = function (e, t, i) {
                    var n = (t = "string" == typeof t ? { effect: t } : t) ? (!0 !== t && "number" != typeof t && t.effect) || r : o,
                        s = !u.isEmptyObject((t = "number" == typeof (t = t || {}) ? { duration: t } : t));
                    (t.complete = i),
        ...
        u(document).on("mouseup", function () {
            ...
            u.widget("ui.mouse", {
                ...
                _mouseInit: function () {
                    ...
                    this.element
                        ...
                        .on("click." + this.widgetName, function (t) {
                            return !0 === u.data(t.target, e.widgetName + ".preventClickEvent") ? (u.removeData(t.target, e.widgetName + ".preventClickEvent"), t.stopImmediatePropagation(), !1) : void 0;
                        }),
                        (this.started = !1);
                },
                ...
                _mouseDown: function (t) {
                    if (!o) {
                        ...
                        var e = this,
                            i = 1 === t.which,
                            n = !("string" != typeof this.options.cancel || !t.target.nodeName) && u(t.target).closest(this.options.cancel).length;
                        return (
                            i &&
                                !n &&
                                ...
                                this._mouseDistanceMet(t) && this._mouseDelayMet(t) && ((this._mouseStarted = !1 !== this._mouseStart(t)), !this._mouseStarted)
                                    ? t.preventDefault()
                                    : (!0 === u.data(t.target, this.widgetName + ".preventClickEvent") && u.removeData(t.target, this.widgetName + ".preventClickEvent"),
                ...
                _mouseUp: function (t) {
                    this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate),
                        this._mouseStarted && ((this._mouseStarted = !1), t.target === this._mouseDownEvent.target && u.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)),
            ...
            u.widget("ui.slider", u.ui.mouse, {
                ...
                _createHandles: function () {
                    ...
                    (this.handles = i.add(u(n.join("")).appendTo(this.element))),
                ...
                _mouseCapture: function (t) {
                    ...
                    return (
                        ...
                        this.handles.each(function (t) {
                            ...
                            (e < n || (n === e && (t === a._lastChangedValue || a.values(t) === l.min))) && ((n = e), (s = u(this)), (o = t));
                        }),
                        !1 !== this._start(t, o) &&
                    ...
                    keydown: function (t) {
                        ...
                        switch (t.keyCode) {
                            ...
                            case u.ui.keyCode.LEFT:
                                if ((t.preventDefault(), !this._keySliding && ((this._keySliding = !0), this._addClass(u(t.target), null, "ui-state-active"), !1 === this._start(t, s)))) return;
                        }
                    ...
                    c(this).each(function (t, e) {
                        ...
                        s.attr("novalidate", "true"),
                            ...
                            s.submit(function () {
                                    ...
                                    c.ajax({
                                        ...
                                        success: function (e) {
                                            ...
                                            "en" !== a.language &&
                                                ...
                                                c.ajaxChimp.translations[a.language][c.ajaxChimp.responses[i]] &&
                                                (i = c.ajaxChimp.translations[a.language][c.ajaxChimp.responses[i]]),
                                                r.html(i),
                                                r.show(2e3),
                                ...
                                t = "Submitting...";
                                return (
                                    "en" !== a.language && c.ajaxChimp.translations && c.ajaxChimp.translations[a.language] && c.ajaxChimp.translations[a.language].submit && (t = c.ajaxChimp.translations[a.language].submit),
                                    r.html(t).show(2e3),
                                    !1
                                );
                            });
    ...
    (function (t) {
        ...
        (t.prototype = {
            ...
            open: function (t) {
                ...
                if (!f.isOpen) {
                    ...
                    d("BeforeOpen"),
                        ...
                        f.fixedContentPos ? f.wrap.css({ overflow: f.st.overflowY, overflowX: "hidden", overflowY: f.st.overflowY }) : f.wrap.css({ top: x.scrollTop(), position: "absolute" }),
            ...
            updateSize: function (t) {
                var e;
                f.isIOS ? ((e = document.documentElement.clientWidth / window.innerWidth), (e = window.innerHeight * e), f.wrap.css("height", e), (f.wH = e)) : (f.wH = t || x.height()),
            ...
            updateStatus: function (t, e) {
                ...
                f.preloader &&
                    ...
                    (i = { status: t, text: (e = !e && "loading" === t ? f.st.tLoading : e) }),
                    d("UpdateStatus", i),
                    (t = i.status),
            ...
            (c.fn.magnificPopup = function (t) {
                ...
                return (
                    "string" == typeof t
                        ? "open" === t
                            ? ((e = w ? s.data("magnificPopup") : s[0].magnificPopup),
                              (i = parseInt(arguments[1], 10) || 0),
                              (n = e.items ? e.items[i] : ((n = s), (n = e.delegate ? n.find(e.delegate) : n).eq(i))),
                              f._openClick({ mfpEl: n }, s, e))
                            : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1))
                        : ((t = c.extend(!0, {}, t)), w ? s.data("magnificPopup", t) : (s[0].magnificPopup = t), f.addGroup(s, t)),
                    s
                );
            });
        function C() {
            k && (T.after(k.addClass(E)).detach(), (k = null));
        }
        var E,
            T,
            k,
            ...
            proto: {
                ...
                getInline: function (t, e) {
                    if ((C(), t.src)) {
                        ...
                        return (
                            s.length
                                ? ((i = s[0].parentNode) && i.tagName && (T || ((E = n.hiddenClass), (T = h(E)), (E = "mfp-" + E)), (k = s.after(T).detach().removeClass(E))), f.updateStatus("ready"))
                                : (f.updateStatus("error", n.tNotFound), (s = c("<div>"))),
                            (t.inlineElement = s)
                        );
                    }
        ...
        c.magnificPopup.registerModule(L, {
            ...
            proto: {
                initAjax: function () {
                    f.types.push(L), (O = f.st.ajax.cursor), u(a + "." + L, D), u("BeforeChange." + L, D);
                },
                getAjax: function (n) {
        ...
        c.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function (t) {
                    t.img && ((t.hasSize = !0), N && clearInterval(N), (t.isCheckingImgSize = !1), d("ImageHasSize", t), t.imgHidden && (f.content && f.content.removeClass("mfp-loading"), (t.imgHidden = !1)));
                },
                findImageSize: function (e) {
                    function i(t) {
                        N && clearInterval(N),
                            (N = setInterval(function () {
                                return 0 < s.naturalWidth ? void f._onImageHasSize(e) : (200 < n && clearInterval(N), void (3 === ++n ? i(10) : 40 === n ? i(50) : 100 === n && i(500)));
                            }, t));
                    }
                    var n = 0,
                        s = e.img[0];
                ...
                getImage: function (t, e) {
                    ...
                    return (
                        ...
                        f.resizeImage(),
                        t.hasSize
                            ? (N && clearInterval(N), t.loadError ? (e.addClass("mfp-loading"), f.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), f.updateStatus("ready")))
        ...
        c.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    ...
                    n = { width: e.width(), height: (w ? e.innerHeight() : e[0].offsetHeight) - t - n };
        ...
        c.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                        ...
                        !(!o || !o.enabled) &&
                            ...
                            u("BuildControls" + t, function () {
                                ...
                                1 < f.items.length &&
                                    ...
                                    !f.arrowLeft &&
                                    ((e = o.arrowMarkup),
                                    (t = f.arrowLeft = c(e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(r)),
                                    (e = f.arrowRight = c(e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(r)),
                                    t.click(function () {
                                        f.prev();
                                    }),
                                    e.click(function () {
                ...
                next: function () {
                    (f.direction = !0), (f.index = I(f.index + 1)), f.updateItemHTML();
                },
                prev: function () {
                    (f.direction = !1), (f.index = I(f.index - 1)), f.updateItemHTML();
                },
                goTo: function (t) {
        ...
        u.extend(u.fn, {
            ...
            rules: function (t, e) {
                ...
                if (null != a && (!a.form && l && ((a.form = this.closest("form")[0]), (a.name = this.attr("name"))), null != a.form)) {
                    if (t)
                        switch (((i = u.data(a.form, "validator").settings), (n = i.rules), (s = u.validator.staticRules(a)), t)) {
                            case "add":
                                u.extend(s, u.validator.normalizeRule(e)), delete s.messages, (n[a.name] = s), e.messages && (i.messages[a.name] = u.extend(i.messages[a.name], e.messages));
                                break;
                            case "remove":
                                return e
                                    ? ((r = {}),
                    ...
                    return (
                        (t = u.validator.normalizeRules(u.extend({}, u.validator.classRules(a), u.validator.attributeRules(a), u.validator.dataRules(a), u.validator.staticRules(a)), a)).required &&
                            ((o = t.required), delete t.required, (t = u.extend({ required: o }, t))),
                        t.remote && ((o = t.remote), delete t.remote, (t = u.extend(t, { remote: o }))),
                        t
                    );
                }
            },
            ...
            u.extend(u.validator, {
                ...
                prototype: {
                    init: function () {
                        function t(t) {
                            ...
                            !this.form && n && ((this.form = u(this).closest("form")[0]), (this.name = u(this).attr("name"))),
                                s === this.form && ((e = u.data(this.form, "validator")), (i = "on" + t.type.replace(/^validate/, "")), (n = e.settings)[i] && !u(this).is(n.ignore) && n[i].call(e, this, t));
                        }
                    ...
                    showLabel: function (t, e) {
                        ...
                        o.length
                            ...
                            : ((i = o = u("<" + this.settings.errorElement + ">")
                                  .attr("id", r + "-error")
                    ...
                    stopRequest: function (t, e) {
                        this.pendingRequest--,
                            ...
                            e && 0 === this.pendingRequest && this.formSubmitted && this.form()
                                ? (u(this.currentForm).submit(), this.submitButton && u("input:hidden[name='" + this.submitButton.name + "']", this.currentForm).remove(), (this.formSubmitted = !1))
                ...
                attributeRules: function (t) {
                    ...
                    for (e in u.validator.methods) (i = "required" === e ? ((i = t.getAttribute(e)), "" === i && (i = !0), !!i) : s.attr(e)), this.normalizeAttributeRule(n, o, e, i);
                ...
                dataRules: function (t) {
                    var e,
                        ...
                        s = u(t),
                        o = t.getAttribute("type");
                    for (e in u.validator.methods) (i = s.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase())), "" === i && (i = !0), this.normalizeAttributeRule(n, o, e, i);
                    return n;
                },
                ...
                normalizeRules: function (n, s) {
                    return (
                        ...
                        u.each(["rangelength", "range"], function () {
                            var t;
                            n[this] &&
                                (u.isArray(n[this]) ? (n[this] = [Number(n[this][0]), Number(n[this][1])]) : "string" == typeof n[this] && ((t = n[this].replace(/[\[\]]/g, "").split(/[\s,]+/)), (n[this] = [Number(t[0]), Number(t[1])])));
                        }),
                ...
                methods: {
                    ...
                    step: function (t, e, i) {
                        ...
                        return (o = n(i)), (n(t) > o || s(t) % s(i) != 0) && (c = !1), this.optional(e) || c;
                    },
                                          ...
                                          !0,
                                          {
                                              ...
                                              success: function (t) {
                                                  ...
                                                  (r.settings.messages[s.name][o] = a.originalMessage),
                                                      i
                                                          ? ((e = r.formSubmitted), r.resetInternals(), (r.toHide = r.errorsFor(s)), (r.formSubmitted = e), r.successList.push(s), (r.invalid[s.name] = !1), r.showErrors())
                                                          : ((e = {}), (t = t || r.defaultMessage(s, { method: o, parameters: n })), (e[s.name] = a.message = t), (r.invalid[s.name] = !0), r.showErrors(e)),
                                                      (a.valid = i),
                                                      r.stopRequest(s, i);
                                              },
                                          },
                            ...
                            l.proxy(function (t, e) {
                                return (
                                    "left" === n && e - 30 < i && i < e + 30
                                        ...
                                        ? (s = t + 1)
                                        : this.op(i, "<", e) && this.op(i, ">", r[t + 1] !== a ? r[t + 1] : e - o) && (s = "left" === n ? t + 1 : t),
                                    -1 === s
                                );
                            }, this)
                        ),
    ...
    (function (s) {
        ...
        !(function () {
            return !!e("transition");
        })() || ((s.support.transition = new String(t("transition"))), (s.support.transition.end = i.transition.end[s.support.transition])),
            l() && ((s.support.animation = new String(t("animation"))), (s.support.animation.end = i.animation.end[s.support.animation])),
            n() && ((s.support.transform = new String(t("transform"))), (s.support.transform3d = a()));
    })(window.Zepto || window.jQuery, (window, document)),
    (function (n) {
        "use strict";
        function e(t) {
        ...
        (e.Defaults = { thumbs: !0, thumbImage: !1, thumbContainerClass: "owl-thumbs", thumbItemClass: "owl-thumb-item", moveThumbsInside: !1 }),
            ...
            (e.prototype.render = function () {
                ...
                else for (t = 0; t < this._thumbcontent.length; ++t) this._thumbcontent._thumbcontainer.append("<button class=" + e.thumbItemClass + ">" + this._thumbcontent[t] + "</button>");
            }),
