...
<div class="card border-left-prima shadow h-100 py-2 cab-1">
   <div class="card-body">
      <div class="row no-gutters align-items-center">
		...
		<div class="container">
			<h1>Shopping cart <span>[</span> Home <span class="last-span is-open">]</span></h1>
		</div>
	</header>
		...
		<section id="cart">
            ...
            <article class="product">
                ...
                {{$items }}
                    ...
                    <div title="You have selected this product to be shipped in the color red."  class="color ">  <i class="fa fa-times remove " style="font-size:28px;color:red"></i></div>
	...
	<footer id="site-footer">
		<div class="container clearfix">
			...
			<div class="left">
				<h2 class="subtotal">Subtotal:NGN <span>0.00</span></h2>
				<h3 class="tax">Taxes (5%):NGN <span>0.00</span></h3>
				<h3 class="shipping">Shipping: <span>0.00</span></h3>
			</div>

			<div class="right">
				<h1 class="total">Total:NGN <span>0.00</span></h1>
