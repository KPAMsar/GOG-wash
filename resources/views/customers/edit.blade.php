...
@section('content')
	...
	<div class="col-md-10 mx-auto">
		...
		<form action="{{url('admin/edit-customers/'.$data->id)}}" method="post">
			@csrf
            @method('PUT')
			...
			<div class="card-body">
				<div class="form-group">
					<label>Name</label>
					<input type="text" class="form-control @error('name') is-invalid @enderror" name="firstname" value="{{$data ->id}}" placeholder="Enter Name" autofocus>
                ...
                <div class="form-group">
					<label>Name</label>
					<input type="text" class="form-control @error('name') is-invalid @enderror" name="lastname" value="{{$data ->id}}" placeholder="Enter Last Name" autofocus>
